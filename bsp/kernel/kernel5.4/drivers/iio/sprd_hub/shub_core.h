...
// add 
#define SHUB_SAR0_HANDLE			82 //SENSOR_HANDLE_WAKE_UP_GRIP_SENSOR
#define SHUB_SAR1_HANDLE			84//SENSOR_HANDLE_WAKE_UP_GRIP_SENSOR_WIFI
#define SHUB_SAR2_HANDLE			83//SENSOR_HANDLE_WAKE_UP_GRIP_SENSOR_SUB
struct sar_ctrl {
	int (*batch)(void);
...
#define LIGHT_SENSOR_MAX_VALUE		1000
