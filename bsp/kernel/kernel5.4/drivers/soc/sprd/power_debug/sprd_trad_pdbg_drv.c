...
#include "sprd_trad_pdbg_core.h"
#include "sprd_trad_pdbg_drv.h"
...
static void debug_driver_shutdown(struct platform_device *pdev)
{
	sprd_debug_log_unregister();
}
/* Platform debug data */
...
static struct platform_driver sprd_debuglog_driver = {
	...
	.shutdown = debug_driver_shutdown,
};
