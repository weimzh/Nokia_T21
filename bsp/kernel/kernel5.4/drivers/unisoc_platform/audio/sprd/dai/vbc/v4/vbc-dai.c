...
static const char *dai_id_to_str(int dai_id)
{
	const char * const dai_id_str[BE_DAI_ID_MAX] = {
		...
		[BE_DAI_ID_MM_P_HIFI] = TO_STRING(BE_DAI_ID_MM_P_HIFI),
...
static struct snd_soc_dai_driver vbc_dais[BE_DAI_ID_MAX] = {
	...
	/* 57: BE_DAI_ID_FAST_P_SMART_AMP */
	{
		...
		/* 58: BE_DAI_ID_MM_P_HIFI */
	{
		.name = TO_STRING(BE_DAI_ID_MM_P_HIFI),
		.id = BE_DAI_ID_MM_P_HIFI,
		.playback = {
			.stream_name = "BE_DAI_ID_MM_P_HIFI",
			.aif_name = "BE_IF_ID_MM_P_HIFI",
			.channels_min = 1,
			.channels_max = 2,
			.rates = SNDRV_PCM_RATE_CONTINUOUS,
			.rate_max = 192000,
