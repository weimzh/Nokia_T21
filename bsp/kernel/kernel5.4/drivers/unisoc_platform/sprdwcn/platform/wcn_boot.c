...
static inline int wcn_avdd12_parent_bound_chip(bool enable)
{
	...
	if (!is_boot_ufs)
		return wcn_pmic_do_bound(&marlin_dev->avdd12_parent_bound_chip,
					 enable);
	return 0;
}
