...
#define HARDWARE_SMARTPA_IC_INFO_GET              _IOWR(HARDWARE_ID, 0x40, char[HARDWARE_MAX_ITEM_LONGTH])

#define HARDWARE_CAMERA_INFO_SET                  _IOWR(HARDWARE_ID, 0x81, char[HARDWARE_MAX_ITEM_LONGTH])
//#define HARDWARE_CAM_SET                          _IOWR(HARDWARE_ID, 0x82, char[HARDWARE_MAX_ITEM_LONGTH])
...
typedef struct camera_set_info{
	int  param;
	int  lenth;
	char str[32];
} camera_info;
