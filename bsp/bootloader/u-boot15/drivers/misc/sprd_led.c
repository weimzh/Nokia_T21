...
#define UMP9620_RGB_PD_SW BIT(12)
#define UMP9620_RGB_HW_PD BIT(13)
#define UMP9620_RGB_V     (0xf8)
...
void sprd_led_init(void)
{
	...
	ANA_REG_OR(ANA_REG_GLB_MODULE_EN0, BLTC_EN);
	ANA_REG_OR(ANA_REG_GLB_RTC_CLK_EN0, RTC_BLTC_EN);
	ANA_REG_BIC(ANA_BLTC_CTRL, UMP9620_RGB_PD_SW);
	ANA_REG_BIC(ANA_BLTC_CTRL, UMP9620_RGB_HW_PD);
	ANA_REG_BIC(ANA_BLTC_STS, UMP9620_RGB_V);
