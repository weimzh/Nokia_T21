...
struct sc2721_regulator_platdata {
	u32 index;
	struct regulator_desc *desc;
};

static struct regulator_desc sc2721_regs_desc[] = {
	{ "vddcpu", 0x12, ANA_REG_GLB_POWER_PD_SW, BIT_DCDC_CPU_PD,
	ANA_REG_GLB_DCDC_CPU_VOL, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8), ANA_REG_GLB_DCDC_CH_CTRL, BIT(13)|BIT(14)|BIT(16)|BIT(18)|BIT(19),
	900, 0, 0, 2, {400, 3125}},
	...
	1850, 0, 0, 2, {600, 3125}},
	{ "vddwpa", 0x2, ANA_REG_GLB_DCDC_WPA_REG2, BIT_DCDC_WPA_PD,
	...
	ANA_REG_GLB_LDO_CAMA_REG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7), ANA_REG_GLB_DCDC_CH_CTRL, BIT(9)|BIT(17)|BIT(18)|BIT(20),
	...
	ANA_REG_GLB_LDO_SIM2_REG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7), ANA_REG_GLB_DCDC_CH_CTRL, BIT(8)|BIT(10)|BIT(17)|BIT(18)|BIT(20),
	1800, 0, 0, 2, {1200, 10000}},
	...
	1800, 0, 0, 2, {1200, 10000}},
	{ "vddusb33", 0x10, ANA_REG_GLB_LDO_USB33_PD_REG, BIT_LDO_USB33_PD,
	...
	ANA_REG_GLB_LDO_CAMD_REG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6), ANA_REG_GLB_DCDC_CH_CTRL, BIT(8)|BIT(10)|BIT(17)|BIT(18)|BIT(20),
	1200, 0, 0, 2, {1000, 6250}},
	{ "vddcon", 0x0, ANA_REG_GLB_LDO_CON_REG0, BIT_LDO_CON_PD,
	ANA_REG_GLB_LDO_CON_REG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6), ANA_REG_GLB_DCDC_CH_CTRL, BIT(8)|BIT(10)|BIT(17)|BIT(18)|BIT(20),
	1600, 0, 0, 2, {1100, 6250}},
	{ "vddcamio", 0x0, ANA_REG_GLB_LDO_CAMIO_REG0, BIT_LDO_CAMIO_PD,
	ANA_REG_GLB_LDO_CAMIO_REG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6), ANA_REG_GLB_DCDC_CH_CTRL, BIT(8)|BIT(10)|BIT(17)|BIT(18)|BIT(20),
	1800, 0, 0, 2, {1100, 6250}},
	{ "vdd18", 0x10, ANA_REG_GLB_POWER_PD_SW, BIT_LDO_AVDD18_PD,
	ANA_REG_GLB_LDO_AVDD18_REG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6), ANA_REG_GLB_DCDC_CH_CTRL, BIT(8)|BIT(10)|BIT(17)|BIT(18)|BIT(20),
	1800, 0, 0, 2, {1100, 6250}},
	{ "vddrf18", 0x10, ANA_REG_GLB_LDO_VDDRF18_REG0, BIT_LDO_RF18_PD,
	ANA_REG_GLB_LDO_VDDRF18_REG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6), ANA_REG_GLB_DCDC_CH_CTRL, BIT(8)|BIT(10)|BIT(17)|BIT(18)|BIT(20),
	1800, 0, 0, 2, {1100, 6250}},
	{ "vddrf15", 0x0, ANA_REG_GLB_LDO_VDDRF15_REG0, BIT_LDO_RF15_PD,
	ANA_REG_GLB_LDO_VDDRF15_REG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6), ANA_REG_GLB_DCDC_CH_CTRL, BIT(8)|BIT(10)|BIT(17)|BIT(18)|BIT(20),
	1500, 0, 0, 2, {1100, 6250}},
	{ "vddldomem", 0x10, ANA_REG_GLB_POWER_PD_SW, BIT_LDO_MEM_PD,
	ANA_REG_GLB_LDO_MEM_REG1, BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6), ANA_REG_GLB_DCDC_CH_CTRL, BIT(8)|BIT(10)|BIT(17)|BIT(18)|BIT(20),
	1250, 0, 0, 2, {1100, 6250}},
	{ "vddkpled", 0x10, ANA_REG_GLB_KPLED_CTRL1, BIT_LDO_KPLED_PD,
	ANA_REG_GLB_KPLED_CTRL1, BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14), ANA_REG_GLB_DCDC_CH_CTRL, BIT(8)|BIT(9)|BIT(10),
	1800, 0, 0, 2, {1200, 10000}}
};

static int sc2721_dcdc_get_trimming_step(struct regulator_desc *desc, int to_vol)
{
	return 1000 * 100 / 32;	/*uV */
}

static int sc2721_match_vol(struct regulator_desc *desc, u32 vol)
{
...
static int sc2721_dcdc_get_voltage(struct udevice *dev, struct regulator_desc *desc)
{
	struct regulator_desc *regs = desc;
	u32 mv = 0, tmp = 0;
	int ret, cal = 0, i = 0;
	...
	if (regs->vol_ctl) {
		...
		if (regs->vol_trm) {
			...
			cal *= sc2721_dcdc_get_trimming_step(desc, 0);	/*uV */
		}

		dev_info(dev, "%s %d +%dmv(trim %#x)\n", regs->name, mv, cal / 1000, cal / sc2721_dcdc_get_trimming_step(regs, 0));
...
static int sc2721_dcdc_set_voltage(struct udevice *dev, struct regulator_desc *desc, int min_mV, int max_mV)
{
	struct regulator_desc *regs = desc;
	...
	/* dcdc calibration control bits (default 0) small adjust voltage: 100/32mv ~= 3.125mv */
	{
		...
		if (regs->vol_ctl) {
			...
			step = sc2721_dcdc_get_trimming_step(regs, mv);
...
static int sc2721_ldo_get_voltage(struct udevice *dev, struct regulator_desc *desc)
{
	struct regulator_desc *regs = desc;
	int ret, shft;
	u32 vol, trim, tmp = 0;
...
static int sc2721_ldo_set_trimming(struct udevice *dev, struct regulator_desc *desc, int def_vol, int to_vol, int adc_vol)
{
	struct regulator_desc *regs = desc;
...
static int sc2721_regulator_disable(struct udevice *dev, struct regulator_desc *desc)
{
	if (!desc)
		return -EINVAL;
...
static int sc2721_regulator_enable(struct udevice *dev, struct regulator_desc *desc)
{
	if (!desc)
		return -EINVAL;
...
static int sc2721_regulator_get_enable(struct udevice *dev)
{
	u32 pd_state = 0;
	int shft, ret;
	struct udevice *pmic = dev->parent;
	struct sc2721_regulator_platdata *plat = dev_get_platdata(dev);
...
static int sc2721_regulator_set_enable(struct udevice *dev, bool enable)
{
	struct sc2721_regulator_platdata *plat = dev_get_platdata(dev);
	struct regulator_desc *desc = plat->desc;
	struct udevice *pmic = dev->parent;
	...
	if (enable)
		sc2721_regulator_enable(pmic, desc);
	else
		sc2721_regulator_disable(pmic, desc);

	return 0;
}

static int sc2721_regulator_get_value(struct udevice *dev)
{
	int vdd_type;
	u32 vol = 0;
	struct sc2721_regulator_platdata *plat = dev_get_platdata(dev);
	...
	if (vdd_type == DCDC_TYPE)
		vol = sc2721_dcdc_get_voltage(pmic, desc);
	else if (vdd_type == LDO_TYPE)
		vol = sc2721_ldo_get_voltage(pmic, desc);

	return vol * 1000;
}

static int sc2721_regulator_set_value(struct udevice *dev, int uV)
{
	int vdd_type, ret = 0;
	u32 to_vol = uV / 1000;
	struct sc2721_regulator_platdata *plat = dev_get_platdata(dev);
	...
	vdd_type = desc->type & (BIT(4) - 1);
	if (vdd_type == DCDC_TYPE)
		ret = sc2721_dcdc_set_voltage(pmic, desc, to_vol, 0);
	else if (vdd_type == LDO_TYPE)
		ret = sc2721_ldo_set_trimming(pmic, desc, 0, to_vol, 0);

	return ret;
}

static const struct dm_regulator_ops sc2721_regulator_ops = {
	.get_value  = sc2721_regulator_get_value,
	.set_value  = sc2721_regulator_set_value,
	.get_enable = sc2721_regulator_get_enable,
	.set_enable = sc2721_regulator_set_enable,
};

static int sc2721_regulator_probe(struct udevice *dev)
{
	int i;
	char *check_name;
	struct sc2721_regulator_platdata *plat = dev_get_platdata(dev);
	...
	for (i = 0; i < ARRAY_SIZE(sc2721_regs_desc); i++) {
		if (!strcmp(check_name, sc2721_regs_desc[i].name)) {
			plat->index = i;
			plat->desc = &sc2721_regs_desc[i];
			break;
		}
	}

	if (i == ARRAY_SIZE(sc2721_regs_desc)) {
...
U_BOOT_DRIVER(sc2721_regulator) = {
	.name  = "sc2721-regulator",
	.id = UCLASS_REGULATOR,
	.probe = sc2721_regulator_probe,
	.ops = &sc2721_regulator_ops,
	.platdata_auto_alloc_size = sizeof(struct sc2721_regulator_platdata),
};
