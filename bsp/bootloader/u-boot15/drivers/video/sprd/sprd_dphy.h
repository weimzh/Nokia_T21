...
extern struct sprd_dphy dphy_slave_device;
...
int sprd_regmap_write(void *context, unsigned int reg, unsigned int val);
int sprd_regmap_read(void *context, unsigned int reg, unsigned int *val);
