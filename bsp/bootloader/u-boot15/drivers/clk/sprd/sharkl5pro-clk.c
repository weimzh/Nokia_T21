...
static struct sprd_clk_desc sharkl5pro_audcpapb_gate_desc = {
...
static struct sprd_clk_desc sharkl5pro_audcpahb_gate_desc = {
...
static const char * const dmc_ref_parents[] = { "fac-6m5", "fac-13m",
					"ext-26m" };
...
static const struct udevice_id sprd_sharkl5pro_clk_ids[] = {
	...
	{ .compatible = "sprd,sharkl5pro-mm-gate-clk",	/* 0x62200000 */
	  .data = SHARKL5PRO_MM_GATE },
	{ .compatible = "sprd,sharkl5pro-apapb-gate",	/* 0x71000000 */
	  .data = SHARKL5PRO_APAPB_GATE },
	{ }
};

static void *sharkl5pro_clk_desc_data[] = {
	&sharkl5pro_apahb_gate_desc,
	&sharkl5pro_ap_clk_desc,
	&sharkl5pro_aon_apb_desc,
	&sharkl5pro_aon_gate_desc,
	&sharkl5pro_pmu_gate_desc,
	&sharkl5pro_g0_pll_desc,
	&sharkl5pro_g2_pll_desc,
	&sharkl5pro_g3_pll_desc,
	&sharkl5pro_gc_pll_desc,
	&sharkl5pro_audcpapb_gate_desc,
	&sharkl5pro_audcpahb_gate_desc,
	&sharkl5pro_gpu_clk_desc,
	&sharkl5pro_mm_clk_desc,
	&sharkl5pro_mm_gate_clk_desc,
	&sharkl5pro_apapb_gate_desc
};

static int sharkl5pro_clk_probe(struct udevice *dev)
{
	ulong clk_ids = dev_get_driver_data(dev);
	struct sprd_clk_desc *desc;
	int ret;

	desc = sharkl5pro_clk_desc_data[clk_ids-1];
...
U_BOOT_DRIVER(sharkl5pro_clk_dev) = {
	.name = "sharkl5pro-clk-dev",
	.id = UCLASS_CLK,
	.of_match = sprd_sharkl5pro_clk_ids,
