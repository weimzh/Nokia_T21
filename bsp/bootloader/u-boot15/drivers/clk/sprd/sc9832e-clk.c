...
static struct sprd_clk_desc sc9832e_pmu_gate_desc = {
...
static struct sprd_clk_desc sc9832e_pll_desc = {
...
static struct sprd_clk_desc sc9832e_dpll_desc = {
...
static struct sprd_clk_desc sc9832e_mpll_desc = {
...
static struct sprd_clk_desc sc9832e_rpll_desc = {
...
static struct sprd_clk_desc sc9832e_ap_clk_desc = {
...
static struct sprd_clk_desc sc9832e_aon_prediv_desc = {
...
static struct sprd_clk_desc sc9832e_aonapb_gate_desc = {
...
static struct sprd_clk_desc sc9832e_apapb_gate_desc = {
...
static struct sprd_clk_desc sc9832e_mm_clk_desc = {
...
static struct sprd_clk_desc sc9832e_mm_gate_desc = {
...
static struct sprd_clk_desc sc9832e_apahb_gate_desc = {
...
static const struct udevice_id sprd_sc9832e_clk_ids[] = {
	{ .compatible = "sprd,sc9832e-pmu-gate",	/* 0x402b0000 */
	  .data = SC9832E_PMU_GATE },
	...
	{ .compatible = "sprd,sc9832e-aon-prediv",	/* 0x402d0000 */
	  .data = SC9832E_AON_PREDIV },
	{ .compatible = "sprd,sc9832e-apahb-gate",		/* 0x20e00000 */
	  .data = SC9832E_APAHB_GATE },
	{ .compatible = "sprd,sc9832e-aonapb-gate",		/* 0x402e0000 */
	  .data = SC9832E_AONAPB_GATE },
	{ .compatible = "sprd,sc9832e-gpu-clk",		/* 0x60100000 */
	  .data = SC9832E_GPU_CLK },
	{ .compatible = "sprd,sc9832e-mm-gate",		/* 0x60d00000 */
	  .data = SC9832E_MM_GATE },
	{ .compatible = "sprd,sc9832e-mm-clk",		/* 0x60e00000 */
	  .data = SC9832E_MM_CLK },
	{ .compatible = "sprd,sc9832e-apapb-gate",		/* 0x71300000 */
	  .data = SC9832E_APAPB_GATE },
	{ }
};

static void *sc9832e_clk_desc_data[] = {
	&sc9832e_pmu_gate_desc,
	&sc9832e_pll_desc,
	&sc9832e_dpll_desc,
	&sc9832e_mpll_desc,
	&sc9832e_rpll_desc,
	&sc9832e_ap_clk_desc,
	&sc9832e_aon_prediv_desc,
	&sc9832e_apahb_gate_desc,
	&sc9832e_aonapb_gate_desc,
	&sc9832e_gpu_clk_desc,
	&sc9832e_mm_gate_desc,
	&sc9832e_mm_clk_desc,
	&sc9832e_apapb_gate_desc
};

static int sc9832e_clk_probe(struct udevice *dev)
{
	ulong clk_ids = dev_get_driver_data(dev);
	struct sprd_clk_desc *desc;
	int ret;

	desc = sc9832e_clk_desc_data[clk_ids-1];
...
U_BOOT_DRIVER(sc9832e_clk_dev) = {
	.name = "sc9832e-clk-dev",
	.id = UCLASS_CLK,
	.of_match = sprd_sc9832e_clk_ids,
