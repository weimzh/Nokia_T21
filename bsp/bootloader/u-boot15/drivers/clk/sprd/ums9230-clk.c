...
enum
{
	...
	UMS9230_MM_CLK,
	UMS9230_MM_GATE_CLK,
	UMS9230_AUDCPAPB_GATE,
	UMS9230_AUDCPAHB_GATE
};

static const struct udevice_id sprd_ums9230_clk_ids[] = {
	{ .compatible = "sprd,ums9230-pmu-gate",	/* 0x64020000 */
	  .data = UMS9230_PMU_GATE },
	...
	{ .compatible = "sprd,ums9230-apapb-gate",	/* 0x20000000 */
	  .data = UMS9230_APAPB_GATE },
	{ .compatible = "sprd,ums9230-ap-clk",		/* 0x20010000 */
	  .data = UMS9230_AP_CLK },
	{ .compatible = "sprd,ums9230-apahb-gate",	/* 0x20400000 */
	  .data = UMS9230_APAHB_GATE },
	{ .compatible = "sprd,ums9230-aon-gate",	/* 0x64000000 */
	  .data = UMS9230_AON_GATE },
	{ .compatible = "sprd,ums9230-aonapb-clk",	/* 0x64012000 */
	  .data = UMS9230_AONAPB_CLK },
	{ .compatible = "sprd,ums9230-gpu-clk",		/* 0x23000000 */
	  .data = UMS9230_GPU_CLK },
	{ .compatible = "sprd,ums9230-mm-clk",		/* 0x30010000 */
	  .data = UMS9230_MM_CLK },
	{ .compatible = "sprd,ums9230-mm-gate-clk",	/* 0x30000000 */
	  .data = UMS9230_MM_GATE_CLK },
	{ .compatible = "sprd,ums9230-audcpahb-gate",	/* 0x56000000 */
	  .data = UMS9230_AUDCPAPB_GATE },
	{ .compatible = "sprd,ums9230-audcpapb-gate",	/* 0x5600d000 */
	  .data = UMS9230_AUDCPAPB_GATE },
	{ }
};

static void *ums9230_clk_desc_data[] = {
	&ums9230_pmu_gate_desc,
	&ums9230_g0_pll_desc,
	&ums9230_g3_pll_desc,
	&ums9230_gc_pll_desc,
	&ums9230_apapb_gate_desc,
	&ums9230_ap_clk_desc,
	&ums9230_apahb_gate_desc,
	&ums9230_aon_gate_desc,
	&ums9230_aon_apb_desc,
	&ums9230_gpu_clk_desc,
	&ums9230_mm_clk_desc,
	&ums9230_mm_gate_clk_desc,
	&ums9230_audcpahb_gate_desc,
	&ums9230_audcpapb_gate_desc,
};

static int ums9230_clk_probe(struct udevice *dev)
{
	ulong clk_ids = dev_get_driver_data(dev);
	struct sprd_clk_desc *desc;
	int ret;

	desc = ums9230_clk_desc_data[clk_ids-1];
...
U_BOOT_DRIVER(ums9230_clk_dev) = {
	.name = "ums9230-clk-dev",
	.id = UCLASS_CLK,
	.of_match = sprd_ums9230_clk_ids,
