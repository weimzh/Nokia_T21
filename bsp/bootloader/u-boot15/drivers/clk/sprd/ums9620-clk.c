...
enum
{
	...
	UMS9620_IPA_CLK,
	UMS9620_IPAGLB_GATE,
	UMS9620_IPADISPC_GATE,
	UMS9620_PCIEAPB_GATE,
	UMS9620_PCIE_CLK,
	UMS9620_AIAPB_GATE,
	UMS9620_AI_CLK,
	UMS9620_AI_DVFS_CLK,
...
static const struct udevice_id sprd_ums9620_clk_ids[] = {
	...
	{ .compatible = "sprd,ums9620-g10-pll",		/* 0x64334000 */
	  .data = UMS9620_G10_PLL },
	{ .compatible = "sprd,ums9620-apapb-gate",	/* 0x20100000 */
	  .data = UMS9620_APAPB_GATE },
	{ .compatible = "sprd,ums9620-ap-clk",		/* 0x20010000 */
	  .data = UMS9620_AP_CLK },
	{ .compatible = "sprd,ums9620-apahb-gate",	/* 0x20000000 */
	  .data = UMS9620_APAHB_GATE },
	{ .compatible = "sprd,ums9620-aon-gate",	/* 0x64900000 */
	  .data = UMS9620_AON_GATE },
	{ .compatible = "sprd,ums9620-aonapb-clk",	/* 0x64920000 */
	  .data = UMS9620_AONAPB_CLK },
	{ .compatible = "sprd,ums9620-gpuapb-gate",	/* 0x23000000 */
	  .data = UMS9620_GPUAPB_GATE },
	{ .compatible = "sprd,ums9620-gpu-clk",		/* 0x23010000 */
	  .data = UMS9620_GPU_CLK },
	{ .compatible = "sprd,ums9620-ipaapb-gate",	/* 0x25000000 */
	  .data = UMS9620_IPAAPB_GATE },
	{ .compatible = "sprd,ums9620-ipa-clk",		/* 0x25010000 */
	  .data = UMS9620_IPA_CLK },
	{ .compatible = "sprd,ums9620-ipaglb-gate",	/* 0x25240000 */
	  .data = UMS9620_IPAGLB_GATE },
	{ .compatible = "sprd,ums9620-ipadispc-gate",	/* 0x31800000 */
	  .data = UMS9620_IPADISPC_GATE },
	{ .compatible = "sprd,ums9620-pcieapb-gate",	/* 0x26000000 */
	  .data = UMS9620_PCIEAPB_GATE },
	{ .compatible = "sprd,ums9620-pcie-clk",	/* 0x26004000 */
	  .data = UMS9620_PCIE_CLK },
	{ .compatible = "sprd,ums9620-aiapb-gate",	/* 0x27000000 */
	  .data = UMS9620_AIAPB_GATE },
	{ .compatible = "sprd,ums9620-ai-clk",		/* 0x27004000 */
	  .data = UMS9620_AI_CLK },
	{ .compatible = "sprd,ums9620-ai-dvfs-clk",	/* 0x27008000 */
	  .data = UMS9620_AI_DVFS_CLK },
	{ .compatible = "sprd,ums9620-mm-gate",		/* 0x30000000 */
	  .data = UMS9620_MM_GATE },
	{ .compatible = "sprd,ums9620-mm-clk",		/* 0x30010000 */
	  .data = UMS9620_MM_CLK },
	{ .compatible = "sprd,ums9620-dpu-vsp-gate",	/* 0x30100000 */
	  .data = UMS9620_DPU_VSP_GATE },
	{ .compatible = "sprd,ums9620-dpu-vsp-clk",	/* 0x30010000 */
	  .data = UMS9620_DPU_VSP_CLK },
	{ .compatible = "sprd,ums9620-audcpglb-gate",	/* 0x56200000 */
	  .data = UMS9620_AUDCPGLB_GATE },
	{ .compatible = "sprd,ums9620-audcpapb-gate",	/* 0x56390000 */
	  .data = UMS9620_AUDCPAPB_GATE },
	{ }
};

static void *ums9620_clk_desc_data[] = {
	&ums9620_pmu_gate_desc,
	&ums9620_g1_pll_desc,
	&ums9620_g1l_pll_desc,
	&ums9620_g5l_pll_desc,
	&ums9620_g5r_pll_desc,
	&ums9620_g8_pll_desc,
	&ums9620_g9_pll_desc,
	&ums9620_g10_pll_desc,
	&ums9620_apapb_gate_desc,
	&ums9620_ap_clk_desc,
	&ums9620_apahb_gate_desc,
	&ums9620_aon_gate_desc,
	&ums9620_aonapb_clk_desc,
	&ums9620_gpuapb_gate_desc,
	&ums9620_gpu_clk_desc,
	&ums9620_ipaapb_gate_desc,
	&ums9620_ipa_clk_desc,
	&ums9620_ipaglb_gate_desc,
	&ums9620_ipadispcglb_gate_desc,
	&ums9620_pcieapb_gate_desc,
	&ums9620_pcie_clk_desc,
	&ums9620_aiapb_gate_desc,
	&ums9620_ai_clk_desc,
	&ums9620_ai_dvfs_clk_desc,
	&ums9620_mm_gate_desc,
	&ums9620_mm_clk_desc,
	&ums9620_dpu_vsp_gate_desc,
	&ums9620_dpu_vsp_clk_desc,
	&ums9620_audcpglb_gate_desc,
	&ums9620_audcpapb_gate_desc,
};

static int ums9620_clk_probe(struct udevice *dev)
{
	ulong clk_ids = dev_get_driver_data(dev);
	struct sprd_clk_desc *desc;
	int ret;

	desc = ums9620_clk_desc_data[clk_ids-1];

	if (!desc)
		return -ENODEV;

	ret = sprd_clk_regmap_init(dev, desc);
...
U_BOOT_DRIVER(ums9620_clk_dev) = {
	.name = "ums9620-clk-dev",
	.id = UCLASS_CLK,
	.of_match = sprd_ums9620_clk_ids,
	.probe = ums9620_clk_probe,
	.priv_auto_alloc_size =sizeof(struct sprd_clk_desc),
	.ops = &clk_uclass_ops,
