...
static CLK_FIXED_FACTOR(fac_13m, "fac-13m", "ext-26m",
			2, 1, 0);
static CLK_FIXED_FACTOR(fac_6m5, "fac-6m5", "ext-26m",
			4, 1, 0);
static CLK_FIXED_FACTOR(fac_4m3, "fac-4m3", "ext-26m",
			6, 1, 0);
...
static struct sprd_clk_desc sc9863a_pmu_gate_desc = {
...
static struct sprd_clk_desc sc9863a_pll_desc = {
...
static struct sprd_clk_desc sc9863a_mpll_desc = {
...
static struct sprd_clk_desc sc9863a_rpll_desc = {
...
static struct sprd_clk_desc sc9863a_dpll_desc = {
...
static struct sprd_clk_desc sc9863a_ap_clk_desc = {
...
static const char * const emc_ref_parents[] = { "fac-6m5", "fac-13m", "ext-26m" };
...
static struct sprd_clk_desc sc9863a_aon_clk_desc = {
...
static struct sprd_clk_desc sc9863a_apahb_gate_desc = {
...
static struct sprd_clk_desc sc9863a_aonapb_gate_desc = {
...
static struct sprd_clk_desc sc9863a_mm_gate_desc = {
...
static struct sprd_clk_desc sc9863a_mm_clk_desc = {
...
static struct sprd_clk_desc sc9863a_vspahb_gate_desc = {
...
static struct sprd_clk_desc sc9863a_apapb_gate_desc = {
...
static const struct udevice_id sprd_sc9863a_clk_ids[] = {
	...
	{ .compatible = "sprd,sc9863a-aon-clk",	/* 0x402d0000 */
	  .data = SC9863A_AON_CLK },
	{ .compatible = "sprd,sc9863a-apahb-gate",	/* 0x20e00000 */
	  .data = SC9863A_APAHB_GATE },
	{ .compatible = "sprd,sc9863a-aonapb-gate",	/* 0x402e0000 */
	  .data = SC9863A_AONAPB_GATE },
	{ .compatible = "sprd,sc9863a-mm-gate",	/* 0x60800000 */
	  .data = SC9863A_MM_GATE },
	{ .compatible = "sprd,sc9863a-mm-clk",	/* 0x60900000 */
	  .data = SC9863A_MM_CLK },
	{ .compatible = "sprd,sc9863a-vspahb-gate",	/* 0x62000000 */
	  .data = SC9863A_VSPAHB_GATE },
	{ .compatible = "sprd,sc9863a-apapb-gate",	/* 0x71300000 */
	  .data = SC9863A_APAPB_GATE },
	{ }
};
static void *sc9863a_clk_desc_data[] = {
	&sc9863a_ap_clk_desc,
	&sc9863a_pmu_gate_desc,
	&sc9863a_pll_desc,
	&sc9863a_mpll_desc,
	&sc9863a_rpll_desc,
	&sc9863a_dpll_desc,
	&sc9863a_aon_clk_desc,
	&sc9863a_apahb_gate_desc,
	&sc9863a_aonapb_gate_desc,
	&sc9863a_mm_gate_desc,
	&sc9863a_mm_clk_desc,
	&sc9863a_vspahb_gate_desc,
	&sc9863a_apapb_gate_desc
};

static int sc9863a_clk_probe(struct udevice *dev)
{
	ulong clk_ids = dev_get_driver_data(dev);
	struct sprd_clk_desc *desc;
	int ret;

	desc = sc9863a_clk_desc_data[clk_ids-1];
...
U_BOOT_DRIVER(sc9863a_clk_dev) = {
	.name = "sc9863a-clk-dev",
	.id = UCLASS_CLK,
	.of_match = sprd_sc9863a_clk_ids,
