...
{REG_PIN_UART_MATRIX_MTX_CFG,       0x16581C20},//uart0->ap_uart0; uart1->ps_cp_uart0; uart2->nr_cp_uart0; uart3->nr_cp_uart1; uart4->v3_phy_wci2; uart5->auddsp_uart0; uart6->cm4_uart;
