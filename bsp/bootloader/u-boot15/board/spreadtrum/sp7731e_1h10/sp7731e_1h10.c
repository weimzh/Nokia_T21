...
static void sprd_pmu_init(void)
{
	...
	__raw_writel(__raw_readl(REG_AON_APB_APB_EB0) | BIT_AON_APB_MM_EB |
		BIT_AON_APB_GPU_EB, REG_AON_APB_APB_EB0);
	__raw_writel(__raw_readl(REG_MM_AHB_RF_AHB_EB) | BIT_MM_AHB_RF_CKG_EB,
