...
#define	SPRD_PUBKEY_HASHLEN	(SPRD_PUBKLEN_V2-7)//SPRD_PUBKLEN_V2
...
int secure_efuse_program_sprd(void)
{
	...
	uint8_t sprd_pubkey[SPRD_PUBKLEN_V2]={0,};//SPRD_PUBKLEN_V2
	...
	sprd_get_pubk(gd->verify_base,sprd_pubkey, 0);
