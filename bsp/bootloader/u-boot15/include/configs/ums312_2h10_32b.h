...
#define CONFIG_IDENT_STRING		"SHARKL5"
...
/* SharkL5 Lowpower feature support start */
...
#define CONFIG_DEEP_DROP_EN		CONFIG_DCDCCORE_DEEP_DROP_EN || CONFIG_DCDCSRAM_DEEP_DROP_EN || CONFIG_DCDCMODEM_DEEP_DROP_EN
/* SharkL5 Lowpower feature support end */
...
#define CONFIG_SYS_PROMPT		"sharkl5# "
...
#define CONFIG_DPU_LITE_R2P0
#define CONFIG_DSIH_SPRD_CTRL_RXP0
#define CONFIG_DPHY_SPRD_SHARKL5
...
#define CONFIG_SPRD_UMS312_HW_CHNL
#define CONFIG_SPRDCHG_I2C_BUS 5
#define CONFIG_FAN54015_CHARGE_IC

#define CONFIG_DVFS_ADDR		0x49
#define CINFIG_DVFS_TX_5_REG_ADDR	0x04
#define CINFIG_DVFS_TX_7_REG_ADDR	0x03
