...
#define NR_FIXNV_SIZE 0xB00000
#define NR_RUNNV_SIZE 0xC00000
...
#define CONFIG_DDR_BOOT_BOOTIMAGE_A_ADR   (0x1E0000000)
#define CONFIG_DDR_BOOT_DTBOIMAGE_A_ADR	  (0x12ae00000)
...
#define CONFIG_LCD_RM69299_VISIONOX_MIPI_FHD
