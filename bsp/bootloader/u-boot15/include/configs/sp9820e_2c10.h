...
#define CONFIG_FB_LCD_GC9306_SPI
#define CONFIG_FB_LCD_ST7789V2_SPI
#define CONFIG_FB_LCD_DUMMY_SPI
#define CONFIG_BACKLIGHT_WHTLED

//add by ronghu.zhong for xunrui
#define  CONFIG_SPIMODE_4WIRE_8BIT_SDIO
