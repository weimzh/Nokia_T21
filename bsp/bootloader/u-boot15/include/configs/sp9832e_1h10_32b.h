...
#define CONFIG_CONS_INDEX	1	/* 0 use UART0 for console,i use uart1 */
...
#define CONFIG_SPRD_CLK_SC9832E
...
#define CONFIG_STACKSIZE_IRQ (1024) // IRQ stack
#define CONFIG_STACKSIZE_FIQ (1024) // FIQ stack
