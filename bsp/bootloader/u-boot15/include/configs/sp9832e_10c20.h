...
#define LCM_GPIO_AVDDEN 4
#define LCM_GPIO_AVEEEN 5
#define LCM_GPIO_IOVDDEN 88
#define LCM_GPIO_VDDEN 135
//#define CONFIG_FB_LCD_ILI9881C_MIPI
#define CONFIG_FB_LCD_ST7703_BOE_MIPI_HD
#define CONFIG_DPI_CLK_153_6M 153600000
