...
/* sw auto-adaption crystal_type 32k less or not*/
/*rf board id */
...
#define CONFIG_ETA6937_CHARGE_IC
...
/*Use GPIO to control charge*/
#define CHARGE_EN_USE_GPIO
#define CHARGE_EN_GPIO 32
