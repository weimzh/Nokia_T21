...
/* Distinguish different board */
#define CONFIG_SPRD_SP9820E
#define CONFIG_SPRD_SP9820E_NANDBOOT
...
#define CONFIG_CALIMODE_USE_BOOTIMG
...
#define MTDIDS_DEFAULT "nand0=sprd-nand"
#ifdef NAND_UBOOT_DOUBLE_BAKUP
#define MTDPARTS_DEFAULT "mtdparts=sprd-nand:256k(splloader),1280k(uboot),768k(sml),1024k(trustos),256k(splloaderbak),1280k(ubootbak),768k(smlbak),1024k(trustosbak),-(ubipac)"
#else
