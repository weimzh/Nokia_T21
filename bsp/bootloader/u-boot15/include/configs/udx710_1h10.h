...
#define CONFIG_LOAD_IMAGE_HEAD_ONLY
#define CONFIG_KERNEL_BOOT_CP
#define SUPPORT_WAIT_RC_LOAD_IMG
...
#define CONFIG_AUDCP_BOOT_VECTOR 0x43700040
#define LTE_AGDSP_SIZE  0x00600000
#define LTE_AGDSP_ADDR (0x86e00000 - LTE_AGDSP_SIZE)
...
/* udx710_1h10 boot from ddr, only load bootimage */
#define CONFIG_DDR_BOOT_BOOTIMAGE_ADR   (0x82100000)

#ifdef CONFIG_LOAD_IMAGE_HEAD_ONLY
#define CONFIG_PSCP_HEAD_ADDR (0x88000000)
#define CONFIG_V3PHY_HEAD_ADDR (0x88001000)
#define CONFIG_NRPHY_HEAD_ADDR (0x88002000)

#define CONFIG_PSCP_IMG_ADDR (CONFIG_PSCP_HEAD_ADDR)
#define CONFIG_NRPHY_IMG_ADDR (CONFIG_NRPHY_HEAD_ADDR)
#define CONFIG_V3PHY_IMG_ADDR (CONFIG_V3PHY_HEAD_ADDR)
#else
#define CONFIG_PSCP_IMG_ADDR (0x8d400000)
#define CONFIG_NRPHY_IMG_ADDR (0x94200000)
#define CONFIG_V3PHY_IMG_ADDR (0x9b000000)
#endif
#endif
...
#define CONFIG_7S_RST_THRESHOLD		1	//7S, hold key down for this time to trigger
