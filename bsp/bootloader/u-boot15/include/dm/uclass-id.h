...
enum uclass_id {
	...
	UCLASS_DSPBOOT,         /* dspboot driver */
	UCLASS_DSPBOOT_GENERIC, /* dspboot generic device */
	UCLASS_FGU,		/* fgu driver*/
	UCLASS_CHARGER,		/* charger driver */
	UCLASS_LCD,		/* display driver */
	UCLASS_SENSOR,		/* sensor driver */
	UCLASS_COUNT,
	UCLASS_INVALID = -1,
};
