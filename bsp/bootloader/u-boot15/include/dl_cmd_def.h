...
typedef enum dl_cmd_type {
    ...
    BSL_CMD_HANDSHAKE_CHECK = 0x2B,
    BSL_CMD_CHECK_PARTITION = 0x2D,
    BSL_CMD_READ_VCUR_DATA = 0x2E,
    BSL_CMD_WRITE_VPAC_DATA = 0x2F,
    /* raw data download cmd */
    BSL_CMD_WRITE_RAW_DATA_ENABLE = 0x28,				/* 0x28 */
    BSL_CMD_SET_TIME_STAMP = 0x2C,						/* 0x2C */
    BSL_CMD_DLOAD_RAW_START = 0x31,				/* 0x31 */
    BSL_CMD_WRITE_FLUSH_DATA = 0x32,					/* 0x32 */
    BSL_CMD_DLOAD_RAW_START2 = 0x33,				/* 0x33 raw data v2 */
    BSL_CMD_DISABLE_SELINUX = 0x40,
    BSL_CMD_AUTH_BEGIN = 0x41,
    BSL_CMD_AUTH_END = 0x42,
    BSL_CMD_START_WDG = 0x44,
    BSL_CMD_STOP_WDG = 0x45,
    BSL_CMD_ENABLE_DL_LOG2PC = 0x34,			/* 0x34, log2pc */
    BSL_CMD_DUMP_UBOOT_LOG = 0x35,          /* 0x35 */
    ...
    BSL_CHECK_DATA_ERROR=0xB9,
    BSL_REP_READ_PARTITION=0xBA,
    BSL_REP_DUMP_UBOOT_LOG = 0xBB,
    BSL_REP_READ_VCUR_DATA = 0xBC,
