...
struct ext2_dir_init{
	uint32_t self_inode;
	uint16_t self_direntlen;
	uint8_t self_namelen;
	uint8_t self_filetype;
	char self_name[4];
        uint32_t parent_inode;
        uint16_t parent_direntlen;
        uint8_t parent_namelen;
        uint8_t parent_filetype;
	char parent_name[4];
