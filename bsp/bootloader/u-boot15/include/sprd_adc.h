...
#define ADC_CHANNEL_VBATSENSE	11
#else
...
struct pmic_adc_para {
	uint32_t small_cal_efuse_blk_1v0;
	uint32_t small_cal_efuse_blk_0v1;
	uint32_t big_cal_efuse_blk_3v6;
	uint32_t big_cal_efuse_blk_4v2;
	uint32_t cal_efuse_bit;
	uint32_t blk_width;
};
#else
struct pmic_adc_para {
	uint32_t small_adc_p0;
	uint32_t small_adc_p1;
	uint32_t small_vol_p0;
	uint32_t small_vol_p1;
	uint32_t small_cal_efuse_blk;
	uint32_t small_cal_efuse_bit;
	uint32_t big_adc_p0;
	uint32_t big_adc_p1;
	uint32_t big_vol_p0;
	uint32_t big_vol_p1;
	uint32_t big_cal_efuse_blk;
	uint32_t big_cal_efuse_bit;
	uint32_t blk_width;
	uint32_t adc_data_off;
};
#endif
