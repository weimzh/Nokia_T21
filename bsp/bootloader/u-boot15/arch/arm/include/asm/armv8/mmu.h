...
#define TCR_EL1_IPS_BITS	(UL(2) << 32)	/* 40 bits physical address */
#define TCR_EL2_IPS_BITS	(2 << 16)	/* 40 bits physical address */
#define TCR_EL3_IPS_BITS	(2 << 16)	/* 40 bits physical address */
