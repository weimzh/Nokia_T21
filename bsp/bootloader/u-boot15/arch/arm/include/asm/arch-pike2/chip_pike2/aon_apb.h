...
#define REG_AON_APB_APB_SEC_EB                              SCI_ADDR(CTL_AON_APB_BASE, 0x001C)
...
#define REG_AON_APB_AON_CFG0                                SCI_ADDR(CTL_AON_APB_BASE, 0x0030)
...
#define REG_AON_APB_CSI_4P2L_M_PHY_CTRL                     SCI_ADDR(CTL_AON_APB_BASE, 0x007C)
#define REG_AON_APB_CSI_4P2L_DBG_PHY_CTRL                   SCI_ADDR(CTL_AON_APB_BASE, 0x0080)
#define REG_AON_APB_CSI_4P2L_PHY_CTRL                       SCI_ADDR(CTL_AON_APB_BASE, 0x0084)
...
#define REG_AON_APB_HARD_DFS_HANSHAKE                       SCI_ADDR(CTL_AON_APB_BASE, 0x00AC)
#define REG_AON_APB_APB_EB2                                 SCI_ADDR(CTL_AON_APB_BASE, 0x00B0)
#define REG_AON_APB_WCN_BUS_REMAP                           SCI_ADDR(CTL_AON_APB_BASE, 0x00CC)
#define REG_AON_APB_ANALOG_TSEN_ADC_CONFIG0                 SCI_ADDR(CTL_AON_APB_BASE, 0x00D0)
#define REG_AON_APB_ANALOG_TSEN_ADC_CONFIG1                 SCI_ADDR(CTL_AON_APB_BASE, 0x00D4)
#define REG_AON_APB_WCN_CONFIG0                             SCI_ADDR(CTL_AON_APB_BASE, 0x00D8)
...
#define REG_AON_APB_ANALOG_TSEN_ADC_CONFIG2                 SCI_ADDR(CTL_AON_APB_BASE, 0x0100)
...
#define REG_AON_APB_CPLL_CFG1                               SCI_ADDR(CTL_AON_APB_BASE, 0x0150)
#define REG_AON_APB_CPLL_CFG2                               SCI_ADDR(CTL_AON_APB_BASE, 0x0154)
#define REG_AON_APB_GPLL_CFG1                               SCI_ADDR(CTL_AON_APB_BASE, 0x0158)
#define REG_AON_APB_GPLL_CFG2                               SCI_ADDR(CTL_AON_APB_BASE, 0x015C)
...
#define REG_AON_APB_CPLL_BIST_CTRL                          SCI_ADDR(CTL_AON_APB_BASE, 0x0188)
#define REG_AON_APB_TWPLL_BIST_CTRL                         SCI_ADDR(CTL_AON_APB_BASE, 0x018C)
#define REG_AON_APB_GPLL_BIST_CTRL                          SCI_ADDR(CTL_AON_APB_BASE, 0x0190)
#define REG_AON_APB_DPLL_CTRL                               SCI_ADDR(CTL_AON_APB_BASE, 0x0194)
#define REG_AON_APB_SENSOR_CFG0                             SCI_ADDR(CTL_AON_APB_BASE, 0x01A0)
#define REG_AON_APB_ANALOG_IOS_CFG                          SCI_ADDR(CTL_AON_APB_BASE, 0x01A4)
...
#define REG_AON_APB_CPLL_CFG3                               SCI_ADDR(CTL_AON_APB_BASE, 0x01B8)
#define REG_AON_APB_TWPLL_CFG3                              SCI_ADDR(CTL_AON_APB_BASE, 0x01BC)
#define REG_AON_APB_GPLL_CFG3                               SCI_ADDR(CTL_AON_APB_BASE, 0x01C0)
#define REG_AON_APB_CP_DAP_PAD_CTRL                         SCI_ADDR(CTL_AON_APB_BASE, 0x0200)
#define REG_AON_APB_CA7_PROT_CTRL                           SCI_ADDR(CTL_AON_APB_BASE, 0x0204)
...
#define REG_AON_APB_CP_CONFIG0                              SCI_ADDR(CTL_AON_APB_BASE, 0x0258)
#define REG_AON_APB_CP_CONFIG1                              SCI_ADDR(CTL_AON_APB_BASE, 0x025C)
#define REG_AON_APB_RF_CONFIG                         SCI_ADDR(CTL_AON_APB_BASE, 0x0260)
...
#define REG_AON_APB_AON_MTX_EMC_LP_CTRL                     SCI_ADDR(CTL_AON_APB_BASE, 0x03D4)
#define REG_AON_APB_AON_MTX_MAIN_LP_CTRL                    SCI_ADDR(CTL_AON_APB_BASE, 0x03D8)
#define REG_AON_APB_AON_MTX_SW0_LP_CTRL                     SCI_ADDR(CTL_AON_APB_BASE, 0x03DC)
#define REG_AON_APB_AON_MTX_SW1_LP_CTRL                     SCI_ADDR(CTL_AON_APB_BASE, 0x03E0)
#define REG_AON_APB_AON_MTX__RF_LP_CTRL                     SCI_ADDR(CTL_AON_APB_BASE, 0x03E4)
#define REG_AON_APB_AON_MTX_WCN_LP_CTRL                     SCI_ADDR(CTL_AON_APB_BASE, 0x03E8)
#define REG_AON_APB_SUBSYS_LPC_FORCE_REQ                    SCI_ADDR(CTL_AON_APB_BASE, 0x03F8)
#define REG_AON_APB_SUBSYS_LPC_FORCE_ACK                    SCI_ADDR(CTL_AON_APB_BASE, 0x03FC)
#define REG_AON_APB_DAP_DJTAG_CTRL                          SCI_ADDR(CTL_AON_APB_BASE, 0x0430)
#define REG_AON_APB_EFUSE_CONFIG0                           SCI_ADDR(CTL_AON_APB_BASE, 0x0450)
...
#define REG_AON_APB_TOP_LPC4                                SCI_ADDR(CTL_AON_APB_BASE, 0x0514)
#define REG_AON_APB_TOP_LPC5                                SCI_ADDR(CTL_AON_APB_BASE, 0x0518)
#define REG_AON_APB_DDR_SLEEP_CTRL0                         SCI_ADDR(CTL_AON_APB_BASE, 0x0530)
#define REG_AON_APB_DDR_SLEEP_CTRL1                         SCI_ADDR(CTL_AON_APB_BASE, 0x0534)
#define REG_AON_APB_DDR_SLEEP_CTRL2                         SCI_ADDR(CTL_AON_APB_BASE, 0x0538)
#define REG_AON_APB_DDR_SLEEP_CTRL3                         SCI_ADDR(CTL_AON_APB_BASE, 0x053C)
#define REG_AON_APB_ADI_CONFIG0                             SCI_ADDR(CTL_AON_APB_BASE, 0x0540)
...
#define REG_AON_APB_CA7_RST_MONITOR                         SCI_ADDR(CTL_AON_APB_BASE, 0x3038)
...
#define REG_AON_APB_SIM_HOT_PLUG_CTRL_PUBCP_SIM0            SCI_ADDR(CTL_AON_APB_BASE, 0x3114)
#define REG_AON_APB_SIM_HOT_PLUG_CTRL_PUBCP_SIM1            SCI_ADDR(CTL_AON_APB_BASE, 0x3118)
#define REG_AON_APB_SIM_HOT_PLUG_CTRL_PUBCP_SIM2            SCI_ADDR(CTL_AON_APB_BASE, 0x311C)
#define REG_AON_APB_SIM_HOT_PLUG_CTRL_AP_SIM0               SCI_ADDR(CTL_AON_APB_BASE, 0x3120)
#define REG_AON_APB_DEEP_SLEEP_SOFT                         SCI_ADDR(CTL_AON_APB_BASE, 0x3124)
...
/* bits definitions for REG_AON_APB_APB_SEC_EB, [0x402E001C] */
...
/* bits definitions for REG_AON_APB_AON_CFG0, [0x402E0030] */
...
#define BIT_AON_APB_MPLL_RESERVED(x)                        ( (x) << 22 & (BIT(22)|BIT(23)|BIT(24)|BIT(25)) )
...
#define BIT_AON_APB_DPLL_RESERVED(x)                        ( (x) << 22 & (BIT(22)|BIT(23)|BIT(24)|BIT(25)) )
...
#define BIT_AON_APB_TWPLL_RESERVED(x)                       ( (x) << 22 & (BIT(22)|BIT(23)|BIT(24)|BIT(25)) )
...
#define BIT_AON_APB_REG_PROT_REG(x)                         ( (x) << 0  & (0x0000FFFF) )
...
/* bits definitions for REG_AON_APB_CSI_4P2L_M_PHY_CTRL, [0x402E007C] */
...
#define BIT_AON_APB_CSI_4P2L_RCTL(x)                        ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)) )
#define BIT_AON_APB_CSI_4P2L_RES(x)                         ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_AON_APB_CSI_4P2L_DBG_PHY_CTRL, [0x402E0080] */
#define BIT_AON_APB_CSI_4P2L_DBG_EN                         ( BIT(25) )
#define BIT_AON_APB_CSI_4P2L_DBG_IF_SEL                     ( BIT(24) )
#define BIT_AON_APB_CSI_4P2L_DBG_TRIMBG(x)                  ( (x) << 20 & (BIT(20)|BIT(21)|BIT(22)|BIT(23)) )

/* bits definitions for REG_AON_APB_CSI_4P2L_PHY_CTRL, [0x402E0084] */
...
/* bits definitions for REG_AON_APB_HARD_DFS_HANSHAKE, [0x402E00AC] */
...
/* bits definitions for REG_AON_APB_WCN_BUS_REMAP, [0x402E00CC] */
#define BIT_AON_APB_WCNTODDR_ADDR_OFFSET(x)                 ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_AON_APB_WCNTOAON_ADDR_OFFSET(x)                 ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_AON_APB_ANALOG_TSEN_ADC_CONFIG0, [0x402E00D0] */
#define BIT_AON_APB_RG_TSEN_CHOP_CLKSEL(x)                  ( (x) << 24 & (BIT(24)|BIT(25)) )
#define BIT_AON_APB_RG_TSEN_CLKSEL(x)                       ( (x) << 20 & (BIT(20)|BIT(21)) )
#define BIT_AON_APB_RG_TSEN_SDADC_BIAS(x)                   ( (x) << 16 & (BIT(16)|BIT(17)) )
#define BIT_AON_APB_RG_TSEN_UGBUF_BIAS(x)                   ( (x) << 12 & (BIT(12)|BIT(13)) )
#define BIT_AON_APB_RG_TSEN_SDADC_VCMI(x)                   ( (x) << 8  & (BIT(8)|BIT(9)) )
#define BIT_AON_APB_RG_TSEN_SDADC_VCMO(x)                   ( (x) << 4  & (BIT(4)|BIT(5)) )
#define BIT_AON_APB_RG_UGBUF_CTRL(x)                        ( (x) << 0  & (BIT(0)|BIT(1)) )

/* bits definitions for REG_AON_APB_ANALOG_TSEN_ADC_CONFIG1, [0x402E00D4] */
...
#define BIT_AON_APB_RG_TSEN_ADCLDOREF(x)                    ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)) )
#define BIT_AON_APB_RG_TSEN_ADCLDO_V(x)                     ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_AON_APB_WCN_CONFIG0, [0x402E00D8] */
#define BIT_AON_APB_WCN_GNSS_CM4_ADDR_OFFSET(x)             ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)|BIT(30)|BIT(31)) )
#define BIT_AON_APB_WCN_OFFCHIP_XTRL_EN                     ( BIT(5) )
#define BIT_AON_APB_WCN_XTAL_DIF_SEL_H                      ( BIT(4) )
#define BIT_AON_APB_WCN_CM4_ADDR_REMAP_SEL(x)               ( (x) << 0  & (BIT(0)|BIT(1)) )
...
/* bits definitions for REG_AON_APB_ANALOG_TSEN_ADC_CONFIG2, [0x402E0100] */
#define BIT_AON_APB_RG_TSEN_BIST_CODE(x)                    ( (x) << 12 & (BIT(12)|BIT(13)|BIT(14)) )
#define BIT_AON_APB_RG_TSEN_TEST_CLK_SEL                    ( BIT(9) )
#define BIT_AON_APB_RG_TSEN_BIST_EN                         ( BIT(8) )
#define BIT_AON_APB_RG_TSEN_RESERVED(x)                     ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
...
#define BIT_AON_APB_TOP_REG_SLICE_SOFT_RST(x)               ( (x) << 20 & (BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)|BIT(25)|BIT(26)|BIT(27)) )
...
/* bits definitions for REG_AON_APB_CPLL_CFG1, [0x402E0150] */
#define BIT_AON_APB_CPLL_RESERVED(x)                        ( (x) << 22 & (BIT(22)|BIT(23)|BIT(24)|BIT(25)) )
...
#define BIT_AON_APB_CPLL_IBIAS(x)                           ( (x) << 11 & (BIT(11)|BIT(12)) )
#define BIT_AON_APB_CPLL_N(x)                               ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)) )

/* bits definitions for REG_AON_APB_CPLL_CFG2, [0x402E0154] */
#define BIT_AON_APB_CPLL_NINT(x)                            ( (x) << 23 & (BIT(23)|BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)) )
#define BIT_AON_APB_CPLL_KINT(x)                            ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)) )

/* bits definitions for REG_AON_APB_GPLL_CFG1, [0x402E0158] */
#define BIT_AON_APB_GPLL_RESERVED(x)                        ( (x) << 22 & (BIT(22)|BIT(23)|BIT(24)|BIT(25)) )
...
/* bits definitions for REG_AON_APB_GPLL_CFG2, [0x402E015C] */
...
#define BIT_AON_APB_ANALOG_PLL_RSV(x)                       ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )

/* bits definitions for REG_AON_APB_ANALOG_CFG1, [0x402E0178] */
#define BIT_AON_APB_ANA_BB_RSV(x)                           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
...
/* bits definitions for REG_AON_APB_CPLL_BIST_CTRL, [0x402E0188] */
#define BIT_AON_APB_CPLL_BIST_CNT(x)                        ( (x) << 16 & (0xFFFF0000) )
#define BIT_AON_APB_CPLL_BIST_CTRL(x)                       ( (x) << 1  & (BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)) )
...
/* bits definitions for REG_AON_APB_GPLL_BIST_CTRL, [0x402E0190] */
...
/* bits definitions for REG_AON_APB_SENSOR_CFG0, [0x402E01A0] */
#define BIT_AON_APB_SENSOR_PD_POL(x)                        ( (x) << 4  & (BIT(4)|BIT(5)) )
#define BIT_AON_APB_SENSOR_RST_POL(x)                       ( (x) << 0  & (BIT(0)|BIT(1)) )

/* bits definitions for REG_AON_APB_ANALOG_IOS_CFG, [0x402E01A4] */
...
/* bits definitions for REG_AON_APB_CPLL_CFG3, [0x402E01B8] */
#define BIT_AON_APB_CPLL_CCS_CTRL(x)                        ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_AON_APB_TWPLL_CFG3, [0x402E01BC] */
#define BIT_AON_APB_TWPLL_CCS_CTRL(x)                       ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_AON_APB_GPLL_CFG3, [0x402E01C0] */
...
/* bits definitions for REG_AON_APB_CA7_PROT_CTRL, [0x402E0204] */
#define BIT_AON_APB_CA7_SPNIDEN(x)                          ( (x) << 12 & (BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_AON_APB_CA7_SPIDEN(x)                           ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
#define BIT_AON_APB_CA7_NIDEN(x)                            ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_AON_APB_CA7_DBGEN(x)                            ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )
...
/* bits definitions for REG_AON_APB_CP_CONFIG0, [0x402E0258] */
#define BIT_AON_APB_CP_AXI_VP_BASE(x)                       ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)|BIT(25)|BIT(26)|BIT(27)) )
#define BIT_AON_APB_CP_AXI_VP_SIZE(x)                       ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)) )

/* bits definitions for REG_AON_APB_CP_CONFIG1, [0x402E025C] */
#define BIT_AON_APB_CP_AXI_PP_BASE(x)                       ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)|BIT(25)|BIT(26)|BIT(27)) )
#define BIT_AON_APB_CP_AXI_PP_SIZE(x)                       ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)) )

/* bits definitions for REG_AON_APB_CONFIG, [0x402E0260] */
...
#define BIT_AON_APB_AP_DBG_SIG_SEL(x)                       ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_AON_APB_CP_DBG_MOD_SEL(x)                       ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
...
/* bits definitions for REG_AON_APB_AON_MTX_EMC_LP_CTRL, [0x402E03D4] */
...
#define BIT_AON_APB_LP_NUM_EMC(x)                           ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_AON_APB_AON_MTX_MAIN_LP_CTRL, [0x402E03D8] */
#define BIT_AON_APB_LP_STAT_MAIN                            ( BIT(17) )
#define BIT_AON_APB_LP_EB_MAIN                              ( BIT(16) )
#define BIT_AON_APB_LP_NUM_MAIN(x)                          ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_AON_APB_AON_MTX_SW0_LP_CTRL, [0x402E03DC] */
#define BIT_AON_APB_LP_STAT_SW0                             ( BIT(17) )
#define BIT_AON_APB_LP_EB_SW0                               ( BIT(16) )
#define BIT_AON_APB_LP_NUM_SW0(x)                           ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_AON_APB_AON_MTX_SW1_LP_CTRL, [0x402E03E0] */
#define BIT_AON_APB_LP_STAT_SW1                             ( BIT(17) )
#define BIT_AON_APB_LP_EB_SW1                               ( BIT(16) )
#define BIT_AON_APB_LP_NUM_SW1(x)                           ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_AON_APB_AON_MTX__RF_LP_CTRL, [0x402E03E4] */
#define BIT_AON_APB_LP_STAT_RF                              ( BIT(17) )
#define BIT_AON_APB_LP_EB_RF                                ( BIT(16) )
#define BIT_AON_APB_LP_NUM_RF(x)                            ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_AON_APB_AON_MTX_WCN_LP_CTRL, [0x402E03E8] */
#define BIT_AON_APB_LP_STAT_WCN                             ( BIT(17) )
#define BIT_AON_APB_LP_EB_WCN                               ( BIT(16) )
#define BIT_AON_APB_LP_NUM_WCN(x)                           ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_AON_APB_SUBSYS_LPC_FORCE_REQ, [0x402E03F8] */
...
/* bits definitions for REG_AON_APB_SUBSYS_LPC_FORCE_ACK, [0x402E03FC] */
...
/* bits definitions for REG_AON_APB_EFUSE_CONFIG0, [0x402E0450] */
#define BIT_AON_APB_S_EFS_BOUNDARY(x)                       ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
...
/* bits definitions for REG_AON_APB_TOP_LPC4, [0x402E0514] */
...
/* bits definitions for REG_AON_APB_TOP_LPC5, [0x402E0518] */
...
/* bits definitions for REG_AON_APB_DDR_SLEEP_CTRL0, [0x402E0530] */
#define BIT_AON_APB_CONF_DMC_STOP_CH(x)                     ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)) )
#define BIT_AON_APB_CONF_DMC_SLEEP_CH(x)                    ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)) )
#define BIT_AON_APB_CONF_MODE_SEL                           ( BIT(5) )
#define BIT_AON_APB_CONF_DMC_SLEEP                          ( BIT(4) )
#define BIT_AON_APB_CONF_DMC_STOP                           ( BIT(3) )

/* bits definitions for REG_AON_APB_DDR_SLEEP_CTRL1, [0x402E0534] */
#define BIT_AON_APB_CONF_SUBSYS_HW_EN(x)                    ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)) )
#define BIT_AON_APB_CONF_WAIT_NUM(x)                        ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_AON_APB_DDR_SLEEP_CTRL2, [0x402E0538] */
#define BIT_AON_APB_DDR_SLP_CTRL_DEEP_SLEEP_FORCE_EN        ( BIT(16) )
#define BIT_AON_APB_DDR_SLP_CTRL_FSM_STATE(x)               ( (x) << 12 & (BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_AON_APB_DDR_SLP_CTRL_STAT_INTEN(x)              ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)) )
#define BIT_AON_APB_DDR_SLP_CTRL_STAT_CLR(x)                ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)) )
#define BIT_AON_APB_DDR_SLP_CTRL_STAT(x)                    ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)) )

/* bits definitions for REG_AON_APB_DDR_SLEEP_CTRL3, [0x402E053C] */
#define BIT_AON_APB_CONF_DDR_SLP_REQ(x)                     ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)|BIT(25)) )
#define BIT_AON_APB_CONF_DDR_SLP_ACK(x)                     ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)) )

/* bits definitions for REG_AON_APB_ADI_CONFIG0, [0x402E0540] */
...
/* bits definitions for REG_AON_APB_CA7_RST_MONITOR, [0x402E3038] */
#define BIT_AON_APB_CA7_RST_MONITOR(x)                      ( (x) )
...
/* bits definitions for REG_AON_APB_SIM_HOT_PLUG_CTRL_PUBCP_SIM0, [0x402E3114] */
...
/* bits definitions for REG_AON_APB_SIM_HOT_PLUG_CTRL_PUBCP_SIM1, [0x402E3118] */
...
/* bits definitions for REG_AON_APB_SIM_HOT_PLUG_CTRL_PUBCP_SIM2, [0x402E311C] */
...
/* bits definitions for REG_AON_APB_SIM_HOT_PLUG_CTRL_AP_SIM0, [0x402E3120] */
...
/* bits definitions for REG_AON_APB_DEEP_SLEEP_SOFT, [0x402E3124] */
