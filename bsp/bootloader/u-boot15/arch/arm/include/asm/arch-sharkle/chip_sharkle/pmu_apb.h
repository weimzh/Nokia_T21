...
#define REG_PMU_APB_PD_CA53_TOP_CFG                         SCI_ADDR(CTL_PMU_APB_BASE, 0x0000)
#define REG_PMU_APB_PD_CA53_C0_CFG                          SCI_ADDR(CTL_PMU_APB_BASE, 0x0004)
#define REG_PMU_APB_PD_CA53_C1_CFG                          SCI_ADDR(CTL_PMU_APB_BASE, 0x0008)
#define REG_PMU_APB_PD_CA53_C2_CFG                          SCI_ADDR(CTL_PMU_APB_BASE, 0x000C)
#define REG_PMU_APB_PD_CA53_C3_CFG                          SCI_ADDR(CTL_PMU_APB_BASE, 0x0010)
#define REG_PMU_APB_PD_CA53_TOP_CFG2                        SCI_ADDR(CTL_PMU_APB_BASE, 0x0014)
...
#define REG_PMU_APB_PD_WTLCP_LTE_P1_CFG                     SCI_ADDR(CTL_PMU_APB_BASE, 0x0028)
#define REG_PMU_APB_PD_WTLCP_LTE_P2_CFG                     SCI_ADDR(CTL_PMU_APB_BASE, 0x002C)
#define REG_PMU_APB_PD_WTLCP_LDSP_CFG                       SCI_ADDR(CTL_PMU_APB_BASE, 0x0034)
...
#define REG_PMU_APB_PD_WTLCP_SYS_CFG                        SCI_ADDR(CTL_PMU_APB_BASE, 0x0044)
#define REG_PMU_APB_PD_PUBCP_SYS_CFG                        SCI_ADDR(CTL_PMU_APB_BASE, 0x0048)
#define REG_PMU_APB_PD_WTLCP_LTE_P3_CFG                     SCI_ADDR(CTL_PMU_APB_BASE, 0x004C)
#define REG_PMU_APB_PD_WTLCP_LTE_P4_CFG                     SCI_ADDR(CTL_PMU_APB_BASE, 0x0050)
#define REG_PMU_APB_PUBCP_FRC_STOP_REQ_FOR_WTL              SCI_ADDR(CTL_PMU_APB_BASE, 0x0054)
#define REG_PMU_APB_PD_PUB_SYS_CFG                          SCI_ADDR(CTL_PMU_APB_BASE, 0x005C)
#define REG_PMU_APB_AP_WAKEUP_POR_CFG                       SCI_ADDR(CTL_PMU_APB_BASE, 0x0060)
...
#define REG_PMU_APB_PLL_WAIT_CNT1                           SCI_ADDR(CTL_PMU_APB_BASE, 0x0078)
#define REG_PMU_APB_PLL_WAIT_CNT2                           SCI_ADDR(CTL_PMU_APB_BASE, 0x007C)
#define REG_PMU_APB_XTL0_REL_CFG                            SCI_ADDR(CTL_PMU_APB_BASE, 0x0080)
#define REG_PMU_APB_XTL1_REL_CFG                            SCI_ADDR(CTL_PMU_APB_BASE, 0x0084)
#define REG_PMU_APB_ISPPLL_REL_CFG                          SCI_ADDR(CTL_PMU_APB_BASE, 0x0088)
#define REG_PMU_APB_XTLBUF0_REL_CFG                         SCI_ADDR(CTL_PMU_APB_BASE, 0x008C)
#define REG_PMU_APB_XTLBUF1_REL_CFG                         SCI_ADDR(CTL_PMU_APB_BASE, 0x0090)
...
#define REG_PMU_APB_LTEPLL_REL_CFG                          SCI_ADDR(CTL_PMU_APB_BASE, 0x009C)
#define REG_PMU_APB_TWPLL_REL_CFG                           SCI_ADDR(CTL_PMU_APB_BASE, 0x00A0)
#define REG_PMU_APB_GPLL_REL_CFG                            SCI_ADDR(CTL_PMU_APB_BASE, 0x00A8)
#define REG_PMU_APB_RPLL_REL_CFG                            SCI_ADDR(CTL_PMU_APB_BASE, 0x00AC)
#define REG_PMU_APB_CP_SOFT_RST                             SCI_ADDR(CTL_PMU_APB_BASE, 0x00B0)
...
#define REG_PMU_APB_PUB_SYS_AUTO_LIGHT_SLEEP_ENABLE         SCI_ADDR(CTL_PMU_APB_BASE, 0x00C8)
...
#define REG_PMU_APB_PUB_SYS_SLEEP_BYPASS_CFG                SCI_ADDR(CTL_PMU_APB_BASE, 0x00D8)
#define REG_PMU_APB_PUB_SYS_DEEP_SLEEP_POLL0                SCI_ADDR(CTL_PMU_APB_BASE, 0x00DC)
#define REG_PMU_APB_PUB_SYS_DEEP_SLEEP_POLL1                SCI_ADDR(CTL_PMU_APB_BASE, 0x00E0)
#define REG_PMU_APB_CA53_TOP_CFG                            SCI_ADDR(CTL_PMU_APB_BASE, 0x00E4)
#define REG_PMU_APB_CA53_C0_CFG                             SCI_ADDR(CTL_PMU_APB_BASE, 0x00E8)
#define REG_PMU_APB_CA53_C1_CFG                             SCI_ADDR(CTL_PMU_APB_BASE, 0x00EC)
#define REG_PMU_APB_CA53_C2_CFG                             SCI_ADDR(CTL_PMU_APB_BASE, 0x00F0)
#define REG_PMU_APB_CA53_C3_CFG                             SCI_ADDR(CTL_PMU_APB_BASE, 0x00F4)
#define REG_PMU_APB_DDR_CHN_SLEEP_CTRL0                     SCI_ADDR(CTL_PMU_APB_BASE, 0x00F8)
#define REG_PMU_APB_DDR_CHN_SLEEP_CTRL1                     SCI_ADDR(CTL_PMU_APB_BASE, 0x00FC)
#define REG_PMU_APB_PD_WCN_SYS_CFG                          SCI_ADDR(CTL_PMU_APB_BASE, 0x0100)
#define REG_PMU_APB_PD_WIFI_WRAP_CFG                        SCI_ADDR(CTL_PMU_APB_BASE, 0x0104)
#define REG_PMU_APB_PD_GNSS_WRAP_CFG                        SCI_ADDR(CTL_PMU_APB_BASE, 0x0108)
#define REG_PMU_APB_PWR_STATUS3_DBG                         SCI_ADDR(CTL_PMU_APB_BASE, 0x010C)
...
#define REG_PMU_APB_CLK26M_SEL_CFG                          SCI_ADDR(CTL_PMU_APB_BASE, 0x0134)
...
#define REG_PMU_APB_CA53_CORE_WAKEUP_EN                     SCI_ADDR(CTL_PMU_APB_BASE, 0x0174)
#define REG_PMU_APB_SP_SYS_HOLD_CGM_EN                      SCI_ADDR(CTL_PMU_APB_BASE, 0x0178)
...
#define REG_PMU_APB_RC0_REL_CFG                             SCI_ADDR(CTL_PMU_APB_BASE, 0x0184)
#define REG_PMU_APB_RC1_REL_CFG                             SCI_ADDR(CTL_PMU_APB_BASE, 0x0188)
#define REG_PMU_APB_RC_CNT_WAIT_CFG                         SCI_ADDR(CTL_PMU_APB_BASE, 0x018C)
...
#define REG_PMU_APB_WCN_SYS_CORE_INT_DISABLE                SCI_ADDR(CTL_PMU_APB_BASE, 0x01A4)
#define REG_PMU_APB_GNSS_WRAP_CORE_INT_DISABLE              SCI_ADDR(CTL_PMU_APB_BASE, 0x01A8)
#define REG_PMU_APB_WTLCP_TGDSP_CORE_INT_DISABLE            SCI_ADDR(CTL_PMU_APB_BASE, 0x01B0)
#define REG_PMU_APB_WTLCP_LDSP_CORE_INT_DISABLE             SCI_ADDR(CTL_PMU_APB_BASE, 0x01B4)
#define REG_PMU_APB_PUBCP_CORE_INT_DISABLE                  SCI_ADDR(CTL_PMU_APB_BASE, 0x01B8)
#define REG_PMU_APB_CA53_C0_CORE_INT_DISABLE                SCI_ADDR(CTL_PMU_APB_BASE, 0x01BC)
#define REG_PMU_APB_CA53_C1_CORE_INT_DISABLE                SCI_ADDR(CTL_PMU_APB_BASE, 0x01C0)
#define REG_PMU_APB_CA53_C2_CORE_INT_DISABLE                SCI_ADDR(CTL_PMU_APB_BASE, 0x01C4)
#define REG_PMU_APB_CA53_C3_CORE_INT_DISABLE                SCI_ADDR(CTL_PMU_APB_BASE, 0x01C8)
...
#define REG_PMU_APB_PUBCP_DSLP_ENA                          SCI_ADDR(CTL_PMU_APB_BASE, 0x020C)
#define REG_PMU_APB_WTLCP_DSLP_ENA                          SCI_ADDR(CTL_PMU_APB_BASE, 0x0210)
#define REG_PMU_APB_CA53_TOP_DSLP_ENA                       SCI_ADDR(CTL_PMU_APB_BASE, 0x0214)
#define REG_PMU_APB_SP_SYS_DSLP_ENA                         SCI_ADDR(CTL_PMU_APB_BASE, 0x0218)
#define REG_PMU_APB_LIGHT_SLEEP_ENABLE                      SCI_ADDR(CTL_PMU_APB_BASE, 0x0230)
#define REG_PMU_APB_LIGHT_SLEEP_MON                         SCI_ADDR(CTL_PMU_APB_BASE, 0x0234)
#define REG_PMU_APB_WCN_SYS_DSLP_ENA                        SCI_ADDR(CTL_PMU_APB_BASE, 0x0244)
#define REG_PMU_APB_WIFI_WRAP_DSLP_ENA                      SCI_ADDR(CTL_PMU_APB_BASE, 0x0248)
#define REG_PMU_APB_GNSS_WRAP_DSLP_ENA                      SCI_ADDR(CTL_PMU_APB_BASE, 0x024C)
...
#define REG_PMU_APB_LVDSRFPLL_REL_CFG                       SCI_ADDR(CTL_PMU_APB_BASE, 0x0280)
#define REG_PMU_APB_PAD_OUT_ADIE_CTRL0                      SCI_ADDR(CTL_PMU_APB_BASE, 0x0290)
#define REG_PMU_APB_PAD_OUT_ADIE_CTRL1                      SCI_ADDR(CTL_PMU_APB_BASE, 0x0294)
...
#define REG_PMU_APB_DDR_SLP_WAIT_CNT                        SCI_ADDR(CTL_PMU_APB_BASE, 0x0338)
#define REG_PMU_APB_PMU_CLK_DIV_CFG                         SCI_ADDR(CTL_PMU_APB_BASE, 0x033C)
#define REG_PMU_APB_CGM_PMU_SEL                             SCI_ADDR(CTL_PMU_APB_BASE, 0x0340)
#define REG_PMU_APB_PWR_DGB_PARAMETER                       SCI_ADDR(CTL_PMU_APB_BASE, 0x0344)
#define REG_PMU_APB_CA53_C0_DSLP_ENA                        SCI_ADDR(CTL_PMU_APB_BASE, 0x0348)
#define REG_PMU_APB_CA53_C1_DSLP_ENA                        SCI_ADDR(CTL_PMU_APB_BASE, 0x034C)
#define REG_PMU_APB_CA53_C2_DSLP_ENA                        SCI_ADDR(CTL_PMU_APB_BASE, 0x0350)
#define REG_PMU_APB_CA53_C3_DSLP_ENA                        SCI_ADDR(CTL_PMU_APB_BASE, 0x0354)
#define REG_PMU_APB_CA53_GIC_RST_EN                         SCI_ADDR(CTL_PMU_APB_BASE, 0x0358)
#define REG_PMU_APB_ANALOG_PHY_PD_CFG                       SCI_ADDR(CTL_PMU_APB_BASE, 0x035C)
#define REG_PMU_APB_PUB_SYS_DEEP_SLEEP_SEL                  SCI_ADDR(CTL_PMU_APB_BASE, 0x0360)
#define REG_PMU_APB_PD_CA53_C0_SHUTDOWN_MARK_STATUS         SCI_ADDR(CTL_PMU_APB_BASE, 0x3000)
#define REG_PMU_APB_PD_CA53_C1_SHUTDOWN_MARK_STATUS         SCI_ADDR(CTL_PMU_APB_BASE, 0x3004)
#define REG_PMU_APB_PD_CA53_C2_SHUTDOWN_MARK_STATUS         SCI_ADDR(CTL_PMU_APB_BASE, 0x3008)
#define REG_PMU_APB_PD_CA53_C3_SHUTDOWN_MARK_STATUS         SCI_ADDR(CTL_PMU_APB_BASE, 0x300C)
#define REG_PMU_APB_PD_CA53_TOP_SHUTDOWN_MARK_STATUS        SCI_ADDR(CTL_PMU_APB_BASE, 0x3010)
...
#define REG_PMU_APB_PD_WTLCP_TD_SHUTDOWN_MARK_STATUS        SCI_ADDR(CTL_PMU_APB_BASE, 0x3020)
#define REG_PMU_APB_PD_WTLCP_LTE_P1_SHUTDOWN_MARK_STATUS    SCI_ADDR(CTL_PMU_APB_BASE, 0x3024)
#define REG_PMU_APB_PD_WTLCP_LTE_P2_SHUTDOWN_MARK_STATUS    SCI_ADDR(CTL_PMU_APB_BASE, 0x3028)
#define REG_PMU_APB_PD_WTLCP_LDSP_SHUTDOWN_MARK_STATUS      SCI_ADDR(CTL_PMU_APB_BASE, 0x3030)
...
#define REG_PMU_APB_PD_WTLCP_HU3GE_B_SHUTDOWN_MARK_STATUS   SCI_ADDR(CTL_PMU_APB_BASE, 0x303C)
#define REG_PMU_APB_PD_WTLCP_SYS_SHUTDOWN_MARK_STATUS       SCI_ADDR(CTL_PMU_APB_BASE, 0x3040)
#define REG_PMU_APB_PD_PUBCP_SYS_SHUTDOWN_MARK_STATUS       SCI_ADDR(CTL_PMU_APB_BASE, 0x3044)
#define REG_PMU_APB_PD_WTLCP_LTE_P3_SHUTDOWN_MARK_STATUS    SCI_ADDR(CTL_PMU_APB_BASE, 0x3048)
#define REG_PMU_APB_PD_WTLCP_LTE_P4_SHUTDOWN_MARK_STATUS    SCI_ADDR(CTL_PMU_APB_BASE, 0x304C)
#define REG_PMU_APB_PD_PUB_SYS_SHUTDOWN_MARK_STATUS         SCI_ADDR(CTL_PMU_APB_BASE, 0x3054)
#define REG_PMU_APB_PD_WCN_SYS_SHUTDOWN_MARK_STATUS         SCI_ADDR(CTL_PMU_APB_BASE, 0x3058)
#define REG_PMU_APB_PD_WIFI_WRAP_SHUTDOWN_MARK_STATUS       SCI_ADDR(CTL_PMU_APB_BASE, 0x305C)
#define REG_PMU_APB_PD_GNSS_WRAP_SHUTDOWN_MARK_STATUS       SCI_ADDR(CTL_PMU_APB_BASE, 0x3060)
#define REG_PMU_APB_AP_SYS_SLEEP_CNT                        SCI_ADDR(CTL_PMU_APB_BASE, 0x3064)
#define REG_PMU_APB_WTLCP_SYS_SLEEP_CNT                     SCI_ADDR(CTL_PMU_APB_BASE, 0x3068)
#define REG_PMU_APB_PUBCP_SYS_SLEEP_CNT                     SCI_ADDR(CTL_PMU_APB_BASE, 0x306C)
#define REG_PMU_APB_WCN_SYS_SLEEP_CNT                       SCI_ADDR(CTL_PMU_APB_BASE, 0x3070)
#define REG_PMU_APB_PUB_SYS_LIGHT_SLEEP_CNT                 SCI_ADDR(CTL_PMU_APB_BASE, 0x3074)
#define REG_PMU_APB_AP_DEEP_SLEEP_CNT                       SCI_ADDR(CTL_PMU_APB_BASE, 0x3078)
#define REG_PMU_APB_SP_SYS_DEEP_SLEEP_CNT                   SCI_ADDR(CTL_PMU_APB_BASE, 0x307C)
#define REG_PMU_APB_WTLCP_DEEP_SLEEP_CNT                    SCI_ADDR(CTL_PMU_APB_BASE, 0x3080)
#define REG_PMU_APB_PUBCP_DEEP_SLEEP_CNT                    SCI_ADDR(CTL_PMU_APB_BASE, 0x3084)
#define REG_PMU_APB_WCN_SYS_DEEP_SLEEP_CNT                  SCI_ADDR(CTL_PMU_APB_BASE, 0x3088)
#define REG_PMU_APB_PUB_SYS_DEEP_SLEEP_CNT                  SCI_ADDR(CTL_PMU_APB_BASE, 0x308C)
#define REG_PMU_APB_AP_LIGHT_SLEEP_CNT                      SCI_ADDR(CTL_PMU_APB_BASE, 0x3090)
#define REG_PMU_APB_WTLCP_LIGHT_SLEEP_CNT                   SCI_ADDR(CTL_PMU_APB_BASE, 0x3094)
#define REG_PMU_APB_PUBCP_LIGHT_SLEEP_CNT                   SCI_ADDR(CTL_PMU_APB_BASE, 0x3098)
#define REG_PMU_APB_WCN_SYS_LIGHT_SLEEP_CNT                 SCI_ADDR(CTL_PMU_APB_BASE, 0x309C)
#define REG_PMU_APB_AON_SYS_LIGHT_SLEEP_CNT                 SCI_ADDR(CTL_PMU_APB_BASE, 0x30A0)
#define REG_PMU_APB_SYS_SOFT_RST_BUSY                       SCI_ADDR(CTL_PMU_APB_BASE, 0x30A4)
#define REG_PMU_APB_REG_SYS_SRST_FRC_LP_ACK                 SCI_ADDR(CTL_PMU_APB_BASE, 0x30A8)
#define REG_PMU_APB_SOFT_RST_SEL                            SCI_ADDR(CTL_PMU_APB_BASE, 0x30AC)
#define REG_PMU_APB_REG_SYS_DDR_PWR_HS_ACK                  SCI_ADDR(CTL_PMU_APB_BASE, 0x30B0)
#define REG_PMU_APB_CSI_DSI_PWR_CNT_DONE                    SCI_ADDR(CTL_PMU_APB_BASE, 0x30B4)
#define REG_PMU_APB_PD_AP_SYS_DBG_SHUTDOWN__EN              SCI_ADDR(CTL_PMU_APB_BASE, 0x30B8)
#define REG_PMU_APB_WCN_SYS_SLEEP_XTL_ON_SEL                SCI_ADDR(CTL_PMU_APB_BASE, 0x30BC)
#define REG_PMU_APB_EIC_SYS_SEL                             SCI_ADDR(CTL_PMU_APB_BASE, 0x30C0)
#define REG_PMU_APB_DDR_SLP_CTRL_STATE                      SCI_ADDR(CTL_PMU_APB_BASE, 0x30C4)

/* bits definitions for REG_PMU_APB_PD_CA53_TOP_CFG, [0x402B0000] */
...
#define BIT_PMU_APB_PD_CA53_TOP_PWR_ON_SEQ_DLY(x)           ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_CA53_TOP_ISO_ON_DLY(x)               ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PD_CA53_C0_CFG, [0x402B0004] */
...
#define BIT_PMU_APB_PD_CA53_C0_PWR_ON_DLY(x)                ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_CA53_C0_PWR_ON_SEQ_DLY(x)            ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_CA53_C0_ISO_ON_DLY(x)                ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PD_CA53_C1_CFG, [0x402B0008] */
...
#define BIT_PMU_APB_PD_CA53_C1_PWR_ON_DLY(x)                ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_CA53_C1_PWR_ON_SEQ_DLY(x)            ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_CA53_C1_ISO_ON_DLY(x)                ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PD_CA53_C2_CFG, [0x402B000C] */
...
#define BIT_PMU_APB_PD_CA53_C2_PWR_ON_DLY(x)                ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_CA53_C2_PWR_ON_SEQ_DLY(x)            ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_CA53_C2_ISO_ON_DLY(x)                ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PD_CA53_C3_CFG, [0x402B0010] */
...
#define BIT_PMU_APB_PD_CA53_C3_PWR_ON_DLY(x)                ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_CA53_C3_PWR_ON_SEQ_DLY(x)            ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_CA53_C3_ISO_ON_DLY(x)                ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PD_CA53_TOP_CFG2, [0x402B0014] */
#define BIT_PMU_APB_PD_CA53_TOP_DCDC_PWR_ON_DLY(x)          ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_CA53_TOP_DCDC_PWR_OFF_DLY(x)         ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
...
/* bits definitions for REG_PMU_APB_PD_WTLCP_LTE_P1_CFG, [0x402B0028] */
#define BIT_PMU_APB_PD_WTLCP_LTE_P1_FORCE_SHUTDOWN          ( BIT(25) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P1_AUTO_SHUTDOWN_EN        ( BIT(24) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P1_PWR_ON_DLY(x)           ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P1_PWR_ON_SEQ_DLY(x)       ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P1_ISO_ON_DLY(x)           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PD_WTLCP_LTE_P2_CFG, [0x402B002C] */
#define BIT_PMU_APB_PD_WTLCP_LTE_P2_FORCE_SHUTDOWN          ( BIT(25) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P2_AUTO_SHUTDOWN_EN        ( BIT(24) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P2_PWR_ON_DLY(x)           ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P2_PWR_ON_SEQ_DLY(x)       ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P2_ISO_ON_DLY(x)           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PD_WTLCP_LDSP_CFG, [0x402B0034] */
...
/* bits definitions for REG_PMU_APB_PD_WTLCP_SYS_CFG, [0x402B0044] */
#define BIT_PMU_APB_PD_WTLCP_SYS_FORCE_SHUTDOWN             ( BIT(25) )
#define BIT_PMU_APB_PD_WTLCP_SYS_AUTO_SHUTDOWN_EN           ( BIT(24) )
#define BIT_PMU_APB_PD_WTLCP_SYS_PWR_ON_DLY(x)              ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_WTLCP_SYS_PWR_ON_SEQ_DLY(x)          ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_WTLCP_SYS_ISO_ON_DLY(x)              ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PD_PUBCP_SYS_CFG, [0x402B0048] */
...
#define BIT_PMU_APB_PD_PUBCP_SYS_PWR_ON_DLY(x)              ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_PUBCP_SYS_PWR_ON_SEQ_DLY(x)          ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_PUBCP_SYS_ISO_ON_DLY(x)              ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PD_WTLCP_LTE_P3_CFG, [0x402B004C] */
#define BIT_PMU_APB_PD_WTLCP_LTE_P3_FORCE_SHUTDOWN          ( BIT(25) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P3_AUTO_SHUTDOWN_EN        ( BIT(24) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P3_PWR_ON_DLY(x)           ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P3_PWR_ON_SEQ_DLY(x)       ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P3_ISO_ON_DLY(x)           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PD_WTLCP_LTE_P4_CFG, [0x402B0050] */
#define BIT_PMU_APB_PD_WTLCP_LTE_P4_FORCE_SHUTDOWN          ( BIT(25) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P4_AUTO_SHUTDOWN_EN        ( BIT(24) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P4_PWR_ON_DLY(x)           ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P4_PWR_ON_SEQ_DLY(x)       ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P4_ISO_ON_DLY(x)           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PUBCP_FRC_STOP_REQ_FOR_WTL, [0x402B0054] */
...
/* bits definitions for REG_PMU_APB_AP_WAKEUP_POR_CFG, [0x402B0060] */
...
/* bits definitions for REG_PMU_APB_PLL_WAIT_CNT1, [0x402B0078] */
#define BIT_PMU_APB_LTEPLL_WAIT_CNT(x)                      ( (x) << 24 & (BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)|BIT(30)|BIT(31)) )
...
/* bits definitions for REG_PMU_APB_PLL_WAIT_CNT2, [0x402B007C] */
#define BIT_PMU_APB_ISPPLL_WAIT_CNT(x)                      ( (x) << 24 & (BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)|BIT(30)|BIT(31)) )
#define BIT_PMU_APB_RPLL_WAIT_CNT(x)                        ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_GPLL_WAIT_CNT(x)                        ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
...
/* bits definitions for REG_PMU_APB_XTL1_REL_CFG, [0x402B0084] */
...
/* bits definitions for REG_PMU_APB_ISPPLL_REL_CFG, [0x402B0088] */
...
/* bits definitions for REG_PMU_APB_XTLBUF1_REL_CFG, [0x402B0090] */
...
/* bits definitions for REG_PMU_APB_LTEPLL_REL_CFG, [0x402B009C] */
#define BIT_PMU_APB_LTEPLL_REF_SEL(x)                       ( (x) << 8  & (BIT(8)|BIT(9)) )
...
#define BIT_PMU_APB_TWPLL_REF_SEL(x)                        ( (x) << 8  & (BIT(8)|BIT(9)) )
...
/* bits definitions for REG_PMU_APB_GPLL_REL_CFG, [0x402B00A8] */
...
/* bits definitions for REG_PMU_APB_RPLL_REL_CFG, [0x402B00AC] */
#define BIT_PMU_APB_RPLL_REF_SEL(x)                         ( (x) << 8  & (BIT(8)|BIT(9)) )
...
/* bits definitions for REG_PMU_APB_CP_SOFT_RST, [0x402B00B0] */
...
#define BIT_PMU_APB_PUBCP_DEEP_SLP_DBG(x)                   ( (x) << 16 & (0xFFFF0000) )
#define BIT_PMU_APB_WTLCP_DEEP_SLP_DBG(x)                   ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_PMU_APB_PWR_STATUS0_DBG, [0x402B00BC] */
#define BIT_PMU_APB_PD_AP_SYS_STATE(x)                      ( (x) << 25 & (BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)) )
#define BIT_PMU_APB_PD_CA53_C3_STATE(x)                     ( (x) << 20 & (BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)) )
#define BIT_PMU_APB_PD_CA53_C2_STATE(x)                     ( (x) << 15 & (BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)) )
#define BIT_PMU_APB_PD_CA53_C1_STATE(x)                     ( (x) << 10 & (BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)) )
#define BIT_PMU_APB_PD_CA53_C0_STATE(x)                     ( (x) << 5  & (BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)) )
#define BIT_PMU_APB_PD_CA53_TOP_STATE(x)                    ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)) )

/* bits definitions for REG_PMU_APB_PWR_STATUS1_DBG, [0x402B00C0] */
#define BIT_PMU_APB_PD_WTLCP_LTE_P1_STATE(x)                ( (x) << 25 & (BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P2_STATE(x)                ( (x) << 20 & (BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)) )
#define BIT_PMU_APB_PD_WIFI_WRAP_STATE(x)                   ( (x) << 15 & (BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)) )
#define BIT_PMU_APB_PD_WTLCP_LDSP_STATE(x)                  ( (x) << 10 & (BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)) )
#define BIT_PMU_APB_PD_WTLCP_TGDSP_STATE(x)                 ( (x) << 5  & (BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)) )
#define BIT_PMU_APB_PD_WTLCP_HU3GE_A_STATE(x)               ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)) )

/* bits definitions for REG_PMU_APB_PWR_STATUS2_DBG, [0x402B00C4] */
#define BIT_PMU_APB_PD_GNSS_WRAP_STATE(x)                   ( (x) << 25 & (BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)) )
#define BIT_PMU_APB_PD_PUB_SYS_STATE(x)                     ( (x) << 20 & (BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P4_STATE(x)                ( (x) << 15 & (BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)) )
#define BIT_PMU_APB_PD_WTLCP_LTE_P3_STATE(x)                ( (x) << 10 & (BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)) )
#define BIT_PMU_APB_PD_PUBCP_SYS_STATE(x)                   ( (x) << 5  & (BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)) )
#define BIT_PMU_APB_PD_WTLCP_SYS_STATE(x)                   ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)) )

/* bits definitions for REG_PMU_APB_PUB_SYS_AUTO_LIGHT_SLEEP_ENABLE, [0x402B00C8] */
#define BIT_PMU_APB_PUB_SYS_AUTO_LIGHT_SLEEP_ENABLE(x)      ( (x) )
...
#define BIT_PMU_APB_SP_SYS_SLP_STATUS(x)                    ( (x) << 20 & (BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_WCN_SYS_SLP_STATUS(x)                   ( (x) << 12 & (BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PUBCP_SLP_STATUS(x)                     ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
#define BIT_PMU_APB_WTLCP_SLP_STATUS(x)                     ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_PMU_APB_AP_SLP_STATUS(x)                        ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PUB_SYS_SLEEP_BYPASS_CFG, [0x402B00D8] */
...
/* bits definitions for REG_PMU_APB_PUB_SYS_DEEP_SLEEP_POLL0, [0x402B00DC] */
#define BIT_PMU_APB_WCN_SYS_PUB_SYS_DEEP_SLEEP_POLL(x)      ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PUB_SYS_DEEP_SLEEP_POLL1, [0x402B00E0] */
#define BIT_PMU_APB_AON_PUB_SYS_DEEP_SLEEP_POLL(x)          ( (x) << 24 & (BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)|BIT(29)|BIT(30)|BIT(31)) )
#define BIT_PMU_APB_PUBCP_PUB_SYS_DEEP_SLEEP_POLL(x)        ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_AP_PUB_SYS_DEEP_SLEEP_POLL(x)           ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_WTLCP_PUB_SYS_DEEP_SLEEP_POLL(x)        ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_CA53_TOP_CFG, [0x402B00E4] */
#define BIT_PMU_APB_CA53_L2RSTDISABLE                       ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_C0_CFG, [0x402B00E8] */
#define BIT_PMU_APB_CA53_VINITHI_C0                         ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_C1_CFG, [0x402B00EC] */
#define BIT_PMU_APB_CA53_VINITHI_C1                         ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_C2_CFG, [0x402B00F0] */
#define BIT_PMU_APB_CA53_VINITHI_C2                         ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_C3_CFG, [0x402B00F4] */
...
/* bits definitions for REG_PMU_APB_DDR_CHN_SLEEP_CTRL1, [0x402B00FC] */
...
/* bits definitions for REG_PMU_APB_PD_WCN_SYS_CFG, [0x402B0100] */
...
#define BIT_PMU_APB_PD_WCN_SYS_PWR_ON_DLY(x)                ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_WCN_SYS_PWR_ON_SEQ_DLY(x)            ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_WCN_SYS_ISO_ON_DLY(x)                ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PD_WIFI_WRAP_CFG, [0x402B0104] */
...
#define BIT_PMU_APB_PD_WIFI_WRAP_PWR_ON_DLY(x)              ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_WIFI_WRAP_PWR_ON_SEQ_DLY(x)          ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_WIFI_WRAP_ISO_ON_DLY(x)              ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PD_GNSS_WRAP_CFG, [0x402B0108] */
...
#define BIT_PMU_APB_PD_GNSS_WRAP_PWR_ON_DLY(x)              ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_PD_GNSS_WRAP_PWR_ON_SEQ_DLY(x)          ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_PD_GNSS_WRAP_ISO_ON_DLY(x)              ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PWR_STATUS3_DBG, [0x402B010C] */
#define BIT_PMU_APB_PD_MM_TOP_STATE(x)                      ( (x) << 10 & (BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)) )
#define BIT_PMU_APB_PD_GPU_TOP_STATE(x)                     ( (x) << 5  & (BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)) )
#define BIT_PMU_APB_PD_WCN_SYS_STATE(x)                     ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)) )
...
/* bits definitions for REG_PMU_APB_CLK26M_SEL_CFG, [0x402B0134] */
...
/* bits definitions for REG_PMU_APB_CA53_CORE_WAKEUP_EN, [0x402B0174] */
...
/* bits definitions for REG_PMU_APB_SP_SYS_HOLD_CGM_EN, [0x402B0178] */
...
#define BIT_PMU_APB_PUBCP_PWR_WAIT_CNT(x)                   ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_PMU_APB_WTLCP_PWR_WAIT_CNT(x)                   ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
...
#define BIT_PMU_APB_SP_SYS_PWR_WAIT_CNT(x)                  ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_WCN_SYS_PWR_WAIT_CNT(x)                 ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_RC0_REL_CFG, [0x402B0184] */
...
/* bits definitions for REG_PMU_APB_RC1_REL_CFG, [0x402B0188] */
...
/* bits definitions for REG_PMU_APB_RC_CNT_WAIT_CFG, [0x402B018C] */
#define BIT_PMU_APB_RC1_WAIT_CNT(x)                         ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_PMU_APB_RC0_WAIT_CNT(x)                         ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
...
/* bits definitions for REG_PMU_APB_WCN_SYS_CORE_INT_DISABLE, [0x402B01A4] */
#define BIT_PMU_APB_WCN_SYS_CORE_INT_DISABLE                ( BIT(0) )

/* bits definitions for REG_PMU_APB_GNSS_WRAP_CORE_INT_DISABLE, [0x402B01A8] */
...
/* bits definitions for REG_PMU_APB_WTLCP_LDSP_CORE_INT_DISABLE, [0x402B01B4] */
#define BIT_PMU_APB_WTLCP_LDSP_CORE_INT_DISABLE             ( BIT(0) )

/* bits definitions for REG_PMU_APB_PUBCP_CORE_INT_DISABLE, [0x402B01B8] */
#define BIT_PMU_APB_PUBCP_CORE_INT_DISABLE                  ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_C0_CORE_INT_DISABLE, [0x402B01BC] */
#define BIT_PMU_APB_CA53_C0_CORE_INT_DISABLE                ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_C1_CORE_INT_DISABLE, [0x402B01C0] */
#define BIT_PMU_APB_CA53_C1_CORE_INT_DISABLE                ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_C2_CORE_INT_DISABLE, [0x402B01C4] */
#define BIT_PMU_APB_CA53_C2_CORE_INT_DISABLE                ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_C3_CORE_INT_DISABLE, [0x402B01C8] */
...
/* bits definitions for REG_PMU_APB_WTLCP_LDSP_DSLP_ENA, [0x402B0204] */
...
/* bits definitions for REG_PMU_APB_PUBCP_DSLP_ENA, [0x402B020C] */
#define BIT_PMU_APB_PUBCP_DSLP_ENA                          ( BIT(0) )

/* bits definitions for REG_PMU_APB_WTLCP_DSLP_ENA, [0x402B0210] */
#define BIT_PMU_APB_WTLCP_DSLP_ENA                          ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_TOP_DSLP_ENA, [0x402B0214] */
#define BIT_PMU_APB_CA53_TOP_DSLP_ENA                       ( BIT(0) )

/* bits definitions for REG_PMU_APB_SP_SYS_DSLP_ENA, [0x402B0218] */
...
/* bits definitions for REG_PMU_APB_LIGHT_SLEEP_MON, [0x402B0234] */
...
/* bits definitions for REG_PMU_APB_WCN_SYS_DSLP_ENA, [0x402B0244] */
#define BIT_PMU_APB_WCN_SYS_XTL_STOP_BYPASS                 ( BIT(1) )
#define BIT_PMU_APB_WCN_SYS_DSLP_ENA                        ( BIT(0) )

/* bits definitions for REG_PMU_APB_WIFI_WRAP_DSLP_ENA, [0x402B0248] */
#define BIT_PMU_APB_WIFI_WRAP_DSLP_ENA                      ( BIT(0) )

/* bits definitions for REG_PMU_APB_GNSS_WRAP_DSLP_ENA, [0x402B024C] */
...
#define BIT_PMU_APB_PMU_DEBUG(x)                            ( (x) )
...
/* bits definitions for REG_PMU_APB_LVDSRFPLL_REL_CFG, [0x402B0280] */
#define BIT_PMU_APB_LVDSRFPLL_REF_SEL(x)                    ( (x) << 8  & (BIT(8)|BIT(9)) )
...
/* bits definitions for REG_PMU_APB_PAD_OUT_ADIE_CTRL1, [0x402B0294] */
...
/* bits definitions for REG_PMU_APB_DDR_SLP_WAIT_CNT, [0x402B0338] */
#define BIT_PMU_APB_PUB_SYS_DEEP_SLEEP_WAIT_CNT(x)          ( (x) << 16 & (0xFFFF0000) )
#define BIT_PMU_APB_PUB_SYS_SLEEP_WAIT_CNT(x)               ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_PMU_APB_PMU_CLK_DIV_CFG, [0x402B033C] */
#define BIT_PMU_APB_PWR_ST_CLK_DIV_CFG(x)                   ( (x) << 16 & (0xFFFF0000) )
#define BIT_PMU_APB_SLP_CTRL_CLK_DIV_CFG(x)                 ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_PMU_APB_CGM_PMU_SEL, [0x402B0340] */
#define BIT_PMU_APB_CGM_PMU_SEL_REG(x)                      ( (x) << 0  & (BIT(0)|BIT(1)) )

/* bits definitions for REG_PMU_APB_PWR_DGB_PARAMETER, [0x402B0344] */
...
/* bits definitions for REG_PMU_APB_CA53_C0_DSLP_ENA, [0x402B0348] */
#define BIT_PMU_APB_CA53_C0_DSLP_ENA                        ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_C1_DSLP_ENA, [0x402B034C] */
#define BIT_PMU_APB_CA53_C1_DSLP_ENA                        ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_C2_DSLP_ENA, [0x402B0350] */
#define BIT_PMU_APB_CA53_C2_DSLP_ENA                        ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_C3_DSLP_ENA, [0x402B0354] */
#define BIT_PMU_APB_CA53_C3_DSLP_ENA                        ( BIT(0) )

/* bits definitions for REG_PMU_APB_CA53_GIC_RST_EN, [0x402B0358] */
...
/* bits definitions for REG_PMU_APB_ANALOG_PHY_PD_CFG, [0x402B035C] */
#define BIT_PMU_APB_PHY_PWR_DLY(x)                          ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
...
/* bits definitions for REG_PMU_APB_PUB_SYS_DEEP_SLEEP_SEL, [0x402B0360] */
#define BIT_PMU_APB_PUB_SYS_DEEP_SLEEP_SEL                  ( BIT(0) )

/* bits definitions for REG_PMU_APB_PD_CA53_C0_SHUTDOWN_MARK_STATUS, [0x402B3000] */
#define BIT_PMU_APB_PD_CA53_C0_SHUTDOWN_MARK(x)             ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_CA53_C1_SHUTDOWN_MARK_STATUS, [0x402B3004] */
#define BIT_PMU_APB_PD_CA53_C1_SHUTDOWN_MARK(x)             ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_CA53_C2_SHUTDOWN_MARK_STATUS, [0x402B3008] */
#define BIT_PMU_APB_PD_CA53_C2_SHUTDOWN_MARK(x)             ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_CA53_C3_SHUTDOWN_MARK_STATUS, [0x402B300C] */
#define BIT_PMU_APB_PD_CA53_C3_SHUTDOWN_MARK(x)             ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_CA53_TOP_SHUTDOWN_MARK_STATUS, [0x402B3010] */
#define BIT_PMU_APB_PD_CA53_TOP_SHUTDOWN_MARK(x)            ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )
...
/* bits definitions for REG_PMU_APB_PD_WTLCP_TD_SHUTDOWN_MARK_STATUS, [0x402B3020] */
#define BIT_PMU_APB_PD_WTLCP_TD_SHUTDOWN_MARK(x)            ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_WTLCP_LTE_P1_SHUTDOWN_MARK_STATUS, [0x402B3024] */
#define BIT_PMU_APB_PD_WTLCP_LTE_P1_SHUTDOWN_MARK(x)        ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_WTLCP_LTE_P2_SHUTDOWN_MARK_STATUS, [0x402B3028] */
#define BIT_PMU_APB_PD_WTLCP_LTE_P2_SHUTDOWN_MARK(x)        ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_WTLCP_LDSP_SHUTDOWN_MARK_STATUS, [0x402B3030] */
...
/* bits definitions for REG_PMU_APB_PD_WTLCP_HU3GE_B_SHUTDOWN_MARK_STATUS, [0x402B303C] */
#define BIT_PMU_APB_PD_WTLCP_HU3GE_B_SHUTDOWN_MARK(x)       ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_WTLCP_SYS_SHUTDOWN_MARK_STATUS, [0x402B3040] */
#define BIT_PMU_APB_PD_WTLCP_SYS_SHUTDOWN_MARK(x)           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_PUBCP_SYS_SHUTDOWN_MARK_STATUS, [0x402B3044] */
#define BIT_PMU_APB_PD_PUBCP_SYS_SHUTDOWN_MARK(x)           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_WTLCP_LTE_P3_SHUTDOWN_MARK_STATUS, [0x402B3048] */
#define BIT_PMU_APB_PD_WTLCP_LTE_P3_SHUTDOWN_MARK(x)        ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_WTLCP_LTE_P4_SHUTDOWN_MARK_STATUS, [0x402B304C] */
#define BIT_PMU_APB_PD_WTLCP_LTE_P4_SHUTDOWN_MARK(x)        ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )
...
/* bits definitions for REG_PMU_APB_PD_WCN_SYS_SHUTDOWN_MARK_STATUS, [0x402B3058] */
#define BIT_PMU_APB_PD_WCN_SYS_SHUTDOWN_MARK(x)             ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_WIFI_WRAP_SHUTDOWN_MARK_STATUS, [0x402B305C] */
#define BIT_PMU_APB_PD_WIFI_WRAP_SHUTDOWN_MARK(x)           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_PD_GNSS_WRAP_SHUTDOWN_MARK_STATUS, [0x402B3060] */
#define BIT_PMU_APB_PD_GNSS_WRAP_SHUTDOWN_MARK(x)           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PMU_APB_AP_SYS_SLEEP_CNT, [0x402B3064] */
#define BIT_PMU_APB_AP_SYS_SLEEP_CNT(x)                     ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_WTLCP_SYS_SLEEP_CNT, [0x402B3068] */
#define BIT_PMU_APB_WTLCP_SYS_SLEEP_CNT(x)                  ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PUBCP_SYS_SLEEP_CNT, [0x402B306C] */
#define BIT_PMU_APB_PUBCP_SYS_SLEEP_CNT(x)                  ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_WCN_SYS_SLEEP_CNT, [0x402B3070] */
#define BIT_PMU_APB_WCN_SYS_SLEEP_CNT(x)                    ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PUB_SYS_LIGHT_SLEEP_CNT, [0x402B3074] */
#define BIT_PMU_APB_PUB_SYS_LIGHT_SLEEP_CNT(x)              ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_AP_DEEP_SLEEP_CNT, [0x402B3078] */
#define BIT_PMU_APB_AP_DEEP_SLEEP_CNT(x)                    ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_SP_SYS_DEEP_SLEEP_CNT, [0x402B307C] */
#define BIT_PMU_APB_SP_SYS_DEEP_SLEEP_CNT(x)                ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_WTLCP_DEEP_SLEEP_CNT, [0x402B3080] */
#define BIT_PMU_APB_WTLCP_DEEP_SLEEP_CNT(x)                 ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PUBCP_DEEP_SLEEP_CNT, [0x402B3084] */
#define BIT_PMU_APB_PUBCP_DEEP_SLEEP_CNT(x)                 ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_WCN_SYS_DEEP_SLEEP_CNT, [0x402B3088] */
#define BIT_PMU_APB_WCN_SYS_DEEP_SLEEP_CNT(x)               ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PUB_SYS_DEEP_SLEEP_CNT, [0x402B308C] */
#define BIT_PMU_APB_PUB_SYS_DEEP_SLEEP_CNT(x)               ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_AP_LIGHT_SLEEP_CNT, [0x402B3090] */
#define BIT_PMU_APB_AP_LIGHT_SLEEP_CNT(x)                   ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_WTLCP_LIGHT_SLEEP_CNT, [0x402B3094] */
#define BIT_PMU_APB_WTLCP_LIGHT_SLEEP_CNT(x)                ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_PUBCP_LIGHT_SLEEP_CNT, [0x402B3098] */
#define BIT_PMU_APB_PUBCP_LIGHT_SLEEP_CNT(x)                ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_WCN_SYS_LIGHT_SLEEP_CNT, [0x402B309C] */
#define BIT_PMU_APB_WCN_LIGHT_SLEEP_CNT(x)                  ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_AON_SYS_LIGHT_SLEEP_CNT, [0x402B30A0] */
#define BIT_PMU_APB_AON_LIGHT_SLEEP_CNT(x)                  ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_PMU_APB_SYS_SOFT_RST_BUSY, [0x402B30A4] */
...
/* bits definitions for REG_PMU_APB_REG_SYS_SRST_FRC_LP_ACK, [0x402B30A8] */
...
/* bits definitions for REG_PMU_APB_SOFT_RST_SEL, [0x402B30AC] */
#define BIT_PMU_APB_SOFT_RST_SEL(x)                         ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)) )

/* bits definitions for REG_PMU_APB_REG_SYS_DDR_PWR_HS_ACK, [0x402B30B0] */
...
/* bits definitions for REG_PMU_APB_CSI_DSI_PWR_CNT_DONE, [0x402B30B4] */
...
/* bits definitions for REG_PMU_APB_PD_AP_SYS_DBG_SHUTDOWN__EN, [0x402B30B8] */
#define BIT_PMU_APB_PD_AP_SYS_DBG_SHUTDOWN_EN               ( BIT(0) )

/* bits definitions for REG_PMU_APB_WCN_SYS_SLEEP_XTL_ON_SEL, [0x402B30BC] */
#define BIT_PMU_APB_WCN_SYS_SLEEP_XTL_ON_SEL                ( BIT(0) )

/* bits definitions for REG_PMU_APB_EIC_SYS_SEL, [0x402B30C0] */
#define BIT_PMU_APB_EIC_SYS_SEL(x)                          ( (x) << 0  & (BIT(0)|BIT(1)) )

/* bits definitions for REG_PMU_APB_DDR_SLP_CTRL_STATE, [0x402B30C4] */
#define BIT_PMU_APB_DDR_SLP_CTRL_STATE(x)                   ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )
