...
#define REG_AP_AHB_CA53_RST_SET                             SCI_ADDR(CTL_AP_AHB_BASE, 0x0008)
...
#define REG_AP_AHB_JMP_ADDR_CA53_C0                         SCI_ADDR(CTL_AP_AHB_BASE, 0x0018)
#define REG_AP_AHB_JMP_ADDR_CA53_C1                         SCI_ADDR(CTL_AP_AHB_BASE, 0x001C)
#define REG_AP_AHB_JMP_ADDR_CA53_C2                         SCI_ADDR(CTL_AP_AHB_BASE, 0x0020)
#define REG_AP_AHB_JMP_ADDR_CA53_C3                         SCI_ADDR(CTL_AP_AHB_BASE, 0x0024)
#define REG_AP_AHB_CA53_C0_PU_LOCK                          SCI_ADDR(CTL_AP_AHB_BASE, 0x0028)
#define REG_AP_AHB_CA53_C1_PU_LOCK                          SCI_ADDR(CTL_AP_AHB_BASE, 0x002C)
#define REG_AP_AHB_CA53_C2_PU_LOCK                          SCI_ADDR(CTL_AP_AHB_BASE, 0x0030)
#define REG_AP_AHB_CA53_C3_PU_LOCK                          SCI_ADDR(CTL_AP_AHB_BASE, 0x0034)
#define REG_AP_AHB_CA53_CKG_DIV_CFG                         SCI_ADDR(CTL_AP_AHB_BASE, 0x0038)
#define REG_AP_AHB_MCU_PAUSE                                SCI_ADDR(CTL_AP_AHB_BASE, 0x003C)
#define REG_AP_AHB_MISC_CKG_EN                              SCI_ADDR(CTL_AP_AHB_BASE, 0x0040)
#define REG_AP_AHB_CA53_C0_AUTO_FORCE_SHUTDOWN_EN           SCI_ADDR(CTL_AP_AHB_BASE, 0x0044)
#define REG_AP_AHB_CA53_C1_AUTO_FORCE_SHUTDOWN_EN           SCI_ADDR(CTL_AP_AHB_BASE, 0x0048)
#define REG_AP_AHB_CA53_C2_AUTO_FORCE_SHUTDOWN_EN           SCI_ADDR(CTL_AP_AHB_BASE, 0x004C)
#define REG_AP_AHB_DISP_ASYNC_BRG                           SCI_ADDR(CTL_AP_AHB_BASE, 0x0050)
#define REG_AP_AHB_CA53_CKG_SEL_CFG                         SCI_ADDR(CTL_AP_AHB_BASE, 0x0054)
...
#define REG_AP_AHB_M8_LPC                                   SCI_ADDR(CTL_AP_AHB_BASE, 0x0080)
...
#define REG_AP_AHB_MERGE_M2_LPC                             SCI_ADDR(CTL_AP_AHB_BASE, 0x00A8)
#define REG_AP_AHB_MERGE_S0_LPC                             SCI_ADDR(CTL_AP_AHB_BASE, 0x00AC)
#define REG_AP_AHB_AP_QOS0                                  SCI_ADDR(CTL_AP_AHB_BASE, 0x00B0)
#define REG_AP_AHB_CPU_ASYNC_BRIDGE                         SCI_ADDR(CTL_AP_AHB_BASE, 0x00B4)
#define REG_AP_AHB_AP_QOS1                                  SCI_ADDR(CTL_AP_AHB_BASE, 0x00B8)
#define REG_AP_AHB_AP_QOS2                                  SCI_ADDR(CTL_AP_AHB_BASE, 0x00BC)
#define REG_AP_AHB_CA53_L2                                  SCI_ADDR(CTL_AP_AHB_BASE, 0x00C0)
#define REG_AP_AHB_CA53_MTX_LP                              SCI_ADDR(CTL_AP_AHB_BASE, 0x00C4)
#define REG_AP_AHB_CA53_STANDBY_STATUS                      SCI_ADDR(CTL_AP_AHB_BASE, 0x3008)
#define REG_AP_AHB_SYS_RST                                  SCI_ADDR(CTL_AP_AHB_BASE, 0x3010)
#define REG_AP_AHB_LVDS_PLL_CFG0                            SCI_ADDR(CTL_AP_AHB_BASE, 0x3014)
#define REG_AP_AHB_LVDS_PLL_CFG1                            SCI_ADDR(CTL_AP_AHB_BASE, 0x3018)
...
#define REG_AP_AHB_CE_SEC_EB                                SCI_ADDR(CTL_AP_AHB_BASE, 0x3038)
#define REG_AP_AHB_CE_SEC_SOFT_RST                          SCI_ADDR(CTL_AP_AHB_BASE, 0x303C)
#define REG_AP_AHB_DMA_SOFT_RST                             SCI_ADDR(CTL_AP_AHB_BASE, 0x3040)
#define REG_AP_AHB_DMA_SEC_EB                               SCI_ADDR(CTL_AP_AHB_BASE, 0x3044)
...
/* bits definitions for REG_AP_AHB_CA53_RST_SET, [0x20E00008] */
#define BIT_AP_AHB_GIC_SOFT_RST                             ( BIT(20) )
#define BIT_AP_AHB_CA53_ATB_SOFT_RST(x)                     ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)) )
...
#define BIT_AP_AHB_CA53_ETM_SOFT_RST(x)                     ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
#define BIT_AP_AHB_CA53_DBG_SOFT_RST(x)                     ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_AP_AHB_CA53_CORE_SOFT_RST(x)                    ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )
...
/* bits definitions for REG_AP_AHB_JMP_ADDR_CA53_C0, [0x20E00018] */

/* bits definitions for REG_AP_AHB_JMP_ADDR_CA53_C1, [0x20E0001C] */

/* bits definitions for REG_AP_AHB_JMP_ADDR_CA53_C2, [0x20E00020] */

/* bits definitions for REG_AP_AHB_JMP_ADDR_CA53_C3, [0x20E00024] */

/* bits definitions for REG_AP_AHB_CA53_C0_PU_LOCK, [0x20E00028] */
#define BIT_AP_AHB_CA53_C0_PU_LOCK                          ( BIT(0) )

/* bits definitions for REG_AP_AHB_CA53_C1_PU_LOCK, [0x20E0002C] */
#define BIT_AP_AHB_CA53_C1_PU_LOCK                          ( BIT(0) )

/* bits definitions for REG_AP_AHB_CA53_C2_PU_LOCK, [0x20E00030] */
#define BIT_AP_AHB_CA53_C2_PU_LOCK                          ( BIT(0) )

/* bits definitions for REG_AP_AHB_CA53_C3_PU_LOCK, [0x20E00034] */
#define BIT_AP_AHB_CA53_C3_PU_LOCK                          ( BIT(0) )

/* bits definitions for REG_AP_AHB_CA53_CKG_DIV_CFG, [0x20E00038] */
#define BIT_AP_AHB_CA53_DBG_CKG_DIV(x)                      ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)) )
#define BIT_AP_AHB_CA53_AXI_CKG_DIV(x)                      ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)) )
#define BIT_AP_AHB_CA53_MCU_CKG_DIV(x)                      ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)) )
#define BIT_AP_AHB_CA53_ATB_DIV(x)                          ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)) )

/* bits definitions for REG_AP_AHB_MCU_PAUSE, [0x20E0003C] */
#define BIT_AP_AHB_CPU_AXI_LP_CTRL_DISABLE                  ( BIT(15) )
#define BIT_AP_AHB_CRYPTODISABLE(x)                         ( (x) << 11 & (BIT(11)|BIT(12)|BIT(13)|BIT(14)) )
#define BIT_AP_AHB_CA53_CORE_X_STOP_FORCE(x)                ( (x) << 7  & (BIT(7)|BIT(8)|BIT(9)|BIT(10)) )
...
/* bits definitions for REG_AP_AHB_CA53_C0_AUTO_FORCE_SHUTDOWN_EN, [0x20E00044] */

/* bits definitions for REG_AP_AHB_CA53_C1_AUTO_FORCE_SHUTDOWN_EN, [0x20E00048] */

/* bits definitions for REG_AP_AHB_CA53_C2_AUTO_FORCE_SHUTDOWN_EN, [0x20E0004C] */

/* bits definitions for REG_AP_AHB_DISP_ASYNC_BRG, [0x20E00050] */
...
/* bits definitions for REG_AP_AHB_CA53_CKG_SEL_CFG, [0x20E00054] */
#define BIT_AP_AHB_CA53_MCU_CKG_SEL(x)                      ( (x) << 0  & (BIT(0)|BIT(1)) )

/* bits definitions for REG_AP_AHB_AP_ASYNC_BRG, [0x20E0005C] */
...
/* bits definitions for REG_AP_AHB_S2_LPC, [0x20E00094] */
...
/* bits definitions for REG_AP_AHB_S3_LPC, [0x20E00098] */
...
/* bits definitions for REG_AP_AHB_S4_LPC, [0x20E0009C] */
...
/* bits definitions for REG_AP_AHB_S5_LPC, [0x20E00058] */
...
/* bits definitions for REG_AP_AHB_MERGE_M0_LPC, [0x20E000A0] */
#define BIT_AP_AHB_MERGE_M0_LP_EB                           ( BIT(16) )
#define BIT_AP_AHB_MERGE_M0_LP_NUM(x)                       ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_AP_AHB_MERGE_M1_LPC, [0x20E000A4] */
#define BIT_AP_AHB_MERGE_M1_LP_EB                           ( BIT(16) )
#define BIT_AP_AHB_MERGE_M1_LP_NUM(x)                       ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_AP_AHB_MERGE_M2_LPC, [0x20E000A8] */
#define BIT_AP_AHB_MERGE_M2_LP_EB                           ( BIT(16) )
#define BIT_AP_AHB_MERGE_M2_LP_NUM(x)                       ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_AP_AHB_MERGE_S0_LPC, [0x20E000AC] */
...
/* bits definitions for REG_AP_AHB_AP_QOS0, [0x20E000B0] */
#define BIT_AP_AHB_ARQOS_USB(x)                             ( (x) << 28 & (BIT(28)|BIT(29)|BIT(30)|BIT(31)) )
#define BIT_AP_AHB_AWQOS_USB(x)                             ( (x) << 24 & (BIT(24)|BIT(25)|BIT(26)|BIT(27)) )
...
#define BIT_AP_AHB_ARQOS_CA53(x)                            ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_AP_AHB_AWQOS_CA53(x)                            ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_AP_AHB_CPU_ASYNC_BRIDGE, [0x20E000B4] */
#define BIT_AP_AHB_CPU_SYS_LP_NUM(x)                        ( (x) << 3  & (BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)|BIT(18)) )
...
/* bits definitions for REG_AP_AHB_AP_QOS1, [0x20E000B8] */
...
#define BIT_AP_AHB_ARQOS_EMMC(x)                            ( (x) << 12 & (BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
#define BIT_AP_AHB_AWQOS_EMMC(x)                            ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
#define BIT_AP_AHB_ARQOS_NANDC(x)                           ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_AP_AHB_AWQOS_NANDC(x)                           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_AP_AHB_AP_QOS2, [0x20E000BC] */
#define BIT_AP_AHB_ARQOS_THRESHHOLD_CPU(x)                  ( (x) << 28 & (BIT(28)|BIT(29)|BIT(30)|BIT(31)) )
#define BIT_AP_AHB_AWQOS_THRESHHOLD_CPU(x)                  ( (x) << 24 & (BIT(24)|BIT(25)|BIT(26)|BIT(27)) )
...
/* bits definitions for REG_AP_AHB_CA53_L2, [0x20E000C0] */
...
/* bits definitions for REG_AP_AHB_CA53_MTX_LP, [0x20E000C4] */
#define BIT_AP_AHB_CA53_MTX_LP_NUM(x)                       ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)) )
...
/* bits definitions for REG_AP_AHB_CA53_STANDBY_STATUS, [0x20E03008] */
#define BIT_AP_AHB_CA53_STANDBYWFIL2                        ( BIT(12) )
#define BIT_AP_AHB_CA53_ETMSTANDBYWFX(x)                    ( (x) << 8  & (BIT(8)|BIT(9)|BIT(10)|BIT(11)) )
#define BIT_AP_AHB_CA53_STANDBYWFE(x)                       ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_AP_AHB_CA53_STANDBYWFI(x)                       ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_AP_AHB_SYS_RST, [0x20E03010] */
...
/* bits definitions for REG_AP_AHB_LVDS_PLL_CFG0, [0x20E03014] */

/* bits definitions for REG_AP_AHB_LVDS_PLL_CFG1, [0x20E03018] */

/* bits definitions for REG_AP_AHB_AP_QOS_CFG, [0x20E0301C] */
#define BIT_AP_AHB_QOS_R_TMC(x)                             ( (x) << 20 & (BIT(20)|BIT(21)|BIT(22)|BIT(23)) )
#define BIT_AP_AHB_QOS_W_TMC(x)                             ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)) )
#define BIT_AP_AHB_QOS_R_DISPC(x)                           ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)|BIT(7)) )
#define BIT_AP_AHB_QOS_W_DISPC(x)                           ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )
...
/* bits definitions for REG_AP_AHB_DSI_PHY, [0x20E03034] */
...
/* bits definitions for REG_AP_AHB_CE_SEC_EB, [0x20E03038] */
#define BIT_AP_AHB_CE_SEC_EB                                ( BIT(0) )

/* bits definitions for REG_AP_AHB_CE_SEC_SOFT_RST, [0x20E0303C] */
#define BIT_AP_AHB_CE_SEC_SOFT_RST                          ( BIT(0) )

/* bits definitions for REG_AP_AHB_DMA_SOFT_RST, [0x20E03040] */
#define BIT_AP_AHB_DMA_SOFT_RST                             ( BIT(0) )

/* bits definitions for REG_AP_AHB_DMA_SEC_EB, [0x20E03044] */
