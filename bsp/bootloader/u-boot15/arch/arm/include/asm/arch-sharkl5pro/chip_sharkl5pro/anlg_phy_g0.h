...
#define CTL_ANLG_PHY_G0_BASE            SCI_IOMAP(0x32390000)
#endif

/* registers definitions for CTL_ANLG_PHY_G0, 0x32390000 */
...
/* bits definitions for REG_ANLG_PHY_G0_ANALOG_DPLL_TOP_ANA_DPLL_DUMY, [0x32390000] */
...
/* bits definitions for REG_ANLG_PHY_G0_ANALOG_DPLL_TOP_DPLL_CTRL0, [0x32390004] */
...
/* bits definitions for REG_ANLG_PHY_G0_ANALOG_DPLL_TOP_DPLL_CTRL2, [0x32390008] */
...
/* bits definitions for REG_ANLG_PHY_G0_ANALOG_DPLL_TOP_DPLL_CTRL3, [0x3239000C] */
...
/* bits definitions for REG_ANLG_PHY_G0_ANALOG_DPLL_TOP_DPLL_CTRL4, [0x32390010] */
...
/* bits definitions for REG_ANLG_PHY_G0_ANALOG_DPLL_TOP_DPLL_CTRL5, [0x32390014] */
#define BIT_ANLG_PHY_G0_ANALOG_DPLL_TOP_DPLL0_RESERVED(x)   ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_ANLG_PHY_G0_ANALOG_DPLL_TOP_DPLL_CTRL13, [0x32390018] */
...
/* bits definitions for REG_ANLG_PHY_G0_ANALOG_DPLL_TOP_REG_SEL_CFG_0, [0x3239001C] */
