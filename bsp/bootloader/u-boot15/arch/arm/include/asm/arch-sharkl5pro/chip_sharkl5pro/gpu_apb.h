...
/* bits definitions for REG_GPU_APB_CLK_GPU_CORE, [0x60100004] */
...
/* bits definitions for REG_GPU_APB_CLK_GPU_MEM, [0x60100008] */
...
/* bits definitions for REG_GPU_APB_CLK_GPU_SYS, [0x6010000C] */
#define BIT_GPU_APB_CGM_GPU_SYS_DIV(x)                      ( (x) << 4  & (BIT(4)|BIT(5)|BIT(6)) )
#define BIT_GPU_APB_CGM_GPU_SYS_EB                          ( BIT(0) )

/* bits definitions for REG_GPU_APB_GPU_NIC400_QOS, [0x60100010] */
...
/* bits definitions for REG_GPU_APB_LPC_AB_W, [0x60100014] */
...
/* bits definitions for REG_GPU_APB_LPC_M0, [0x60100018] */
...
/* bits definitions for REG_GPU_APB_LPC_S0, [0x6010001C] */
...
/* bits definitions for REG_GPU_APB_LPC_S1, [0x60100020] */
...
/* bits definitions for REG_GPU_APB_ASYBC_BRIDGE_TOP_W, [0x60100024] */
...
/* bits definitions for REG_GPU_APB_GONDUL_Q_CHANNEL, [0x60100028] */
#define BIT_GPU_APB_LP_EB_GONDUL                            ( BIT(16) )
#define BIT_GPU_APB_LP_NUM_GONDUL(x)                        ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_GPU_APB_GONDUL_PDC_CONTROL_STACK0, [0x6010002C] */
...
/* bits definitions for REG_GPU_APB_GONDUL_PDC_CONTROL_STACK1, [0x60100030] */
...
/* bits definitions for REG_GPU_APB_GONDUL_TEXFMTENABLE, [0x60100034] */
#define BIT_GPU_APB_TEXFMTENABLE(x)                         ( (x) )

/* bits definitions for REG_GPU_APB_GONDUL_MISCS, [0x60100038] */
