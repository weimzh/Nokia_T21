...
#define CTL_SP_AHB_BASE                 SCI_IOMAP(0x51000000)
#endif

/* registers definitions for CTL_SP_AHB, 0x51000000 */
...
#define REG_SP_AHB_CM4_CORE_CFG1                            SCI_ADDR(CTL_SP_AHB_BASE, 0x0010)
#define REG_SP_AHB_CM4_CORE_SYSTICK_CFG                     SCI_ADDR(CTL_SP_AHB_BASE, 0x0014)
#define REG_SP_AHB_CM4_CORE_AUXFAULT_CFG                    SCI_ADDR(CTL_SP_AHB_BASE, 0x0018)
...
#define REG_SP_AHB_CM4_INT_STAT                             SCI_ADDR(CTL_SP_AHB_BASE, 0x0024)
...
/* bits definitions for REG_SP_AHB_CFG_CLK_EB, [0x51000000] */
...
/* bits definitions for REG_SP_AHB_SOFT_RST, [0x51000004] */
...
/* bits definitions for REG_SP_AHB_DMA_CTRL, [0x51000008] */
...
/* bits definitions for REG_SP_AHB_SLP_CTL, [0x5100000C] */
#define BIT_SP_AHB_SYS_AUTO_GATE_EN                         ( BIT(2) )
#define BIT_SP_AHB_CORE_AUTO_GATE_EN                        ( BIT(0) )

/* bits definitions for REG_SP_AHB_CM4_CORE_CFG1, [0x51000010] */
...
/* bits definitions for REG_SP_AHB_CM4_CORE_SYSTICK_CFG, [0x51000014] */
...
/* bits definitions for REG_SP_AHB_CM4_CORE_AUXFAULT_CFG, [0x51000018] */
#define BIT_SP_AHB_SOFT_AUXFAULT(x)                         ( (x) )

/* bits definitions for REG_SP_AHB_CM4_MAIN_STATOUT, [0x5100001C] */
...
/* bits definitions for REG_SP_AHB_CM4_HWDATAD_STAT, [0x51000020] */
#define BIT_SP_AHB_HWDATAD_STAT(x)                          ( (x) )

/* bits definitions for REG_SP_AHB_CM4_INT_STAT, [0x51000024] */
#define BIT_SP_AHB_CURRPRI_STAT(x)                          ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_SP_AHB_WDG_ENABLE, [0x51000028] */
#define BIT_SP_AHB_WDG_EB                                   ( BIT(0) )

/* bits definitions for REG_SP_AHB_FPU_CFG, [0x51000034] */
#define BIT_SP_AHB_FPU_DISABLE                              ( BIT(0) )

/* bits definitions for REG_SP_AHB_AHB_MTX_CTL0, [0x51000040] */
...
/* bits definitions for REG_SP_AHB_AHB_MTX_CTL1, [0x51000044] */
...
/* bits definitions for REG_SP_AHB_AHB_MTX_CTL2, [0x51000048] */
...
/* bits definitions for REG_SP_AHB_AHB_MTX_CTL3, [0x5100004C] */
...
/* bits definitions for REG_SP_AHB_AHB_MTX_CTL4, [0x51000050] */
...
/* bits definitions for REG_SP_AHB_SP_AON_DDR_EXTEND, [0x51000060] */
#define BIT_SP_AHB_REG_SP_AON_DDR_EXTEND(x)                 ( (x) << 0  & (BIT(0)|BIT(1)) )

/* bits definitions for REG_SP_AHB_RES_REG, [0x510000FC] */
