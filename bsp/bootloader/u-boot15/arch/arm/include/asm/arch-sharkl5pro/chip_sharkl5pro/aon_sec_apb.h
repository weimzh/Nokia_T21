...
#define CTL_AON_SEC_APB_BASE            SCI_IOMAP(0x32880000)
#endif

/* registers definitions for CTL_AON_SEC_APB, 0x32880000 */
...
/* bits definitions for REG_AON_SEC_APB_CHIP_KPRTL_0, [0x32880000] */
#define BIT_AON_SEC_APB_KPRTL_0(x)                          ( (x) )

/* bits definitions for REG_AON_SEC_APB_CHIP_KPRTL_1, [0x32880004] */
#define BIT_AON_SEC_APB_KPRTL_1(x)                          ( (x) )

/* bits definitions for REG_AON_SEC_APB_CHIP_KPRTL_2, [0x32880008] */
#define BIT_AON_SEC_APB_KPRTL_2(x)                          ( (x) )

/* bits definitions for REG_AON_SEC_APB_CHIP_KPRTL_3, [0x3288000C] */
#define BIT_AON_SEC_APB_KPRTL_3(x)                          ( (x) )

/* bits definitions for REG_AON_SEC_APB_SEC_EB, [0x32880010] */
...
/* bits definitions for REG_AON_SEC_APB_SEC_SOFT_RST, [0x32880014] */
...
/* bits definitions for REG_AON_SEC_APB_FUNC_DMA_EN, [0x32880018] */
#define BIT_AON_SEC_APB_FUNC_DMA_EN                         ( BIT(0) )

/* bits definitions for REG_AON_SEC_APB_AON_SEC_EB, [0x3288001C] */
#define BIT_AON_SEC_APB_ETC_SEC_EB                          ( BIT(2) )
#define BIT_AON_SEC_APB_I2C_SEC_EB                          ( BIT(1) )
#define BIT_AON_SEC_APB_EFUSE_SEC_EB                        ( BIT(0) )

/* bits definitions for REG_AON_SEC_APB_SECURE_EFUSE_BOUNDRY, [0x32880020] */
#define BIT_AON_SEC_APB_SEC_EFUSE_BOUNDRY(x)                ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)) )

/* bits definitions for REG_AON_SEC_APB_APCPU_APB_EB, [0x32880024] */
#define BIT_AON_SEC_APB_APCPU_CSSYS_EB                      ( BIT(0) )

/* bits definitions for REG_AON_SEC_APB_APCPU_SOFT_RST, [0x32880028] */
...
/* bits definitions for REG_AON_SEC_APB_APCPU_CORE0_3_CLK_CFG, [0x3288002C] */
...
/* bits definitions for REG_AON_SEC_APB_APCPU_CORE4_7_CLK_CFG, [0x32880030] */
...
/* bits definitions for REG_AON_SEC_APB_APCPU_BUS_CLK_CFG, [0x32880038] */
...
/* bits definitions for REG_AON_SEC_APB_APCPU_TOP_MISC_CLK_CFG, [0x3288003C] */
...
/* bits definitions for REG_AON_SEC_APB_RVBARADDR0, [0x32880040] */
#define BIT_AON_SEC_APB_RVBARADDR0(x)                       ( (x) )

/* bits definitions for REG_AON_SEC_APB_RVBARADDR1, [0x32880044] */
#define BIT_AON_SEC_APB_RVBARADDR1(x)                       ( (x) )

/* bits definitions for REG_AON_SEC_APB_RVBARADDR2, [0x32880048] */
#define BIT_AON_SEC_APB_RVBARADDR2(x)                       ( (x) )

/* bits definitions for REG_AON_SEC_APB_RVBARADDR3, [0x3288004C] */
#define BIT_AON_SEC_APB_RVBARADDR3(x)                       ( (x) )

/* bits definitions for REG_AON_SEC_APB_RVBARADDR4, [0x32880050] */
#define BIT_AON_SEC_APB_RVBARADDR4(x)                       ( (x) )

/* bits definitions for REG_AON_SEC_APB_RVBARADDR5, [0x32880054] */
#define BIT_AON_SEC_APB_RVBARADDR5(x)                       ( (x) )

/* bits definitions for REG_AON_SEC_APB_RVBARADDR6, [0x32880058] */
#define BIT_AON_SEC_APB_RVBARADDR6(x)                       ( (x) )

/* bits definitions for REG_AON_SEC_APB_RVBARADDR7, [0x3288005C] */
#define BIT_AON_SEC_APB_RVBARADDR7(x)                       ( (x) )

/* bits definitions for REG_AON_SEC_APB_APCPU_CFG_CTRL, [0x32880060] */
...
/* bits definitions for REG_AON_SEC_APB_AON_SEC_APB_RSV_0, [0x32880070] */
#define BIT_AON_SEC_APB_AON_SEC_APB_RSV_0(x)                ( (x) )

/* bits definitions for REG_AON_SEC_APB_AON_SEC_APB_RSV_1, [0x32880074] */
