...
#define CTL_GPU_DVFS_APB_BASE           SCI_IOMAP(0x60110000)
#endif

/* registers definitions for CTL_GPU_DVFS_APB, 0x60110000 */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_DVFS_HOLD_CTRL, [0x60110000] */
#define BIT_GPU_DVFS_APB_GPU_DVFS_HOLD                      ( BIT(0) )

/* bits definitions for REG_GPU_DVFS_APB_GPU_MIN_VOLTAGE_CFG, [0x60110010] */
#define BIT_GPU_DVFS_APB_GPU_TOP_MIN_VOLTAGE(x)             ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)) )

/* bits definitions for REG_GPU_DVFS_APB_GPU_SW_DVFS_CTRL, [0x60110020] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_FREQ_UPDATE_BYPASS, [0x60110024] */
#define BIT_GPU_DVFS_APB_REG_GPU_CORE_FREQ_UPD_EN_BYP       ( BIT(2) )

/* bits definitions for REG_GPU_DVFS_APB_CGM_GPU_DVFS_CLK_GATE_CTRL, [0x60110028] */
#define BIT_GPU_DVFS_APB_CGM_GPU_DVFS_FORCE_EN              ( BIT(1) )
#define BIT_GPU_DVFS_APB_CGM_GPU_DVFS_AUTO_GATE_SEL         ( BIT(0) )

/* bits definitions for REG_GPU_DVFS_APB_GPU_DVFS_VOLTAGE_DBG, [0x6011002C] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_DVFS_CGM_CFG_DBG, [0x60110034] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_DVFS_STATE_DBG, [0x60110038] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_CORE_INDEX0_MAP, [0x60110048] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_CORE_INDEX1_MAP, [0x6011004C] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_CORE_INDEX2_MAP, [0x60110050] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_CORE_INDEX3_MAP, [0x60110054] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_CORE_INDEX4_MAP, [0x60110058] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_CORE_INDEX5_MAP, [0x6011005C] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_CORE_INDEX6_MAP, [0x60110060] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_CORE_INDEX7_MAP, [0x60110064] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_DVFS_INDEX_CFG, [0x6011008C] */
#define BIT_GPU_DVFS_APB_GPU_DVFS_INDEX(x)                  ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)) )

/* bits definitions for REG_GPU_DVFS_APB_GPU_CORE_DVFS_INDEX_IDLE_CFG, [0x60110090] */
#define BIT_GPU_DVFS_APB_GPU_CORE_DVFS_INDEX_IDLE(x)        ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)) )

/* bits definitions for REG_GPU_DVFS_APB_GPU_FREQ_UPD_STATE, [0x60110098] */
#define BIT_GPU_DVFS_APB_GPU_CORE_DVFS_FREQ_UPD_STATE(x)    ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_GPU_DVFS_APB_GPU_GFREE_WAIT_DELAY_CFG, [0x6011009C] */
#define BIT_GPU_DVFS_APB_GPU_CORE_GFREE_WAIT_DELAY(x)       ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)) )

/* bits definitions for REG_GPU_DVFS_APB_GPU_FREQ_UPD_TYPE_CFG, [0x601100A4] */
#define BIT_GPU_DVFS_APB_GPU_CORE_FREQ_UPD_DELAY_EN         ( BIT(1) )
#define BIT_GPU_DVFS_APB_GPU_CORE_FREQ_UPD_HDSK_EN          ( BIT(0) )

/* bits definitions for REG_GPU_DVFS_APB_GPU_DVFS_RESERVED_REG_CFG0, [0x601100A8] */
#define BIT_GPU_DVFS_APB_DVFS_RES_REG0(x)                   ( (x) )

/* bits definitions for REG_GPU_DVFS_APB_GPU_DVFS_RESERVED_REG_CFG1, [0x601100AC] */
#define BIT_GPU_DVFS_APB_DVFS_RES_REG1(x)                   ( (x) )

/* bits definitions for REG_GPU_DVFS_APB_GPU_DVFS_RESERVED_REG_CFG2, [0x601100B0] */
#define BIT_GPU_DVFS_APB_DVFS_RES_REG2(x)                   ( (x) )

/* bits definitions for REG_GPU_DVFS_APB_GPU_DVFS_RESERVED_REG_CFG3, [0x601100B4] */
#define BIT_GPU_DVFS_APB_DVFS_RES_REG3(x)                   ( (x) )

/* bits definitions for REG_GPU_DVFS_APB_GPU_DVFS_WAIT_WINDOW_CFG2, [0x601100C0] */
...
/* bits definitions for REG_GPU_DVFS_APB_GPU_DFS_IDLE_DISABLE_CFG, [0x601100D0] */
