...
#define CTL_SCC_APB_BASE                SCI_IOMAP(0x324D0000)
#endif

/* registers definitions for CTL_SCC_APB, 0x324D0000 */
...
/* bits definitions for REG_SCC_APB_SCC_TUNE_LMT_CFG, [0x324D0000] */
#define BIT_SCC_APB_VOLT_TUNE_VAL_MAX(x)                    ( (x) << 9  & (BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)) )
#define BIT_SCC_APB_VOLT_TUNE_VAL_MIN(x)                    ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)) )

/* bits definitions for REG_SCC_APB_SCC_TUNE_STATUS, [0x324D0004] */
#define BIT_SCC_APB_VOLT_TUNE_VAL(x)                        ( (x) << 9  & (BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)|BIT(16)|BIT(17)) )
#define BIT_SCC_APB_VOLT_OBS_VAL(x)                         ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)) )

/* bits definitions for REG_SCC_APB_SCC_CFG, [0x324D0008] */
...
/* bits definitions for REG_SCC_APB_SCC_TUNE_STEP_CFG, [0x324D000C] */
#define BIT_SCC_APB_VOLT_TUNE_DOWN_STEP(x)                  ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)|BIT(25)) )
#define BIT_SCC_APB_VOLT_TUNE_UP_STEP(x)                    ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)) )

/* bits definitions for REG_SCC_APB_SCC_WAIT_CFG, [0x324D0010] */
#define BIT_SCC_APB_RND_INTVAL_WAIT_NUM(x)                  ( (x) << 16 & (0xFFFF0000) )
#define BIT_SCC_APB_VOLT_STB_WAIT_NUM(x)                    ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_SCC_APB_SCC_INT_CFG, [0x324D0014] */
...
/* bits definitions for REG_SCC_APB_SCC_ROSC_CFG, [0x324D0104] */
...
/* bits definitions for REG_SCC_APB_SCC_ROSC_CTRL, [0x324D0108] */
...
/* bits definitions for REG_SCC_APB_SCC_ROSC_RPT, [0x324D010C] */
...
/* bits definitions for REG_SCC_APB_SCC_ROSC_SW_RST, [0x324D0110] */
