...
#define CTL_PUB_APB_BASE                SCI_IOMAP(0x31050000)
#endif

/* registers definitions for CTL_PUB_APB, 0x31050000 */
...
/* bits definitions for REG_PUB_APB_DDR_EB, [0x31050000] */

/* bits definitions for REG_PUB_APB_DDR_SOFT_RST, [0x31050004] */

/* bits definitions for REG_PUB_APB_DMC_EXT_LPCTRL_CFG, [0x310531A0] */
...
/* bits definitions for REG_PUB_APB_DMC_EXT_LPCTRL_SEQL, [0x310531A4] */
#define BIT_PUB_APB_SOFT_CMD_SEQL(x)                        ( (x) )

/* bits definitions for REG_PUB_APB_DMC_EXT_LPCTRL_SEQH, [0x310531A8] */
#define BIT_PUB_APB_SOFT_CMD_SEQH(x)                        ( (x) )

/* bits definitions for REG_PUB_APB_DMC_EXT_LPCTRL_STEP, [0x310531AC] */
#define BIT_PUB_APB_SOFT_CMD_STEP(x)                        ( (x) )

/* bits definitions for REG_PUB_APB_QOS_SELECT, [0x310531B0] */

/* bits definitions for REG_PUB_APB_DPLL_PRE_DIV_STATUS, [0x310531C0] */
...
/* bits definitions for REG_PUB_APB_DFI_BWMON_TIMER, [0x310531C4] */
...
/* bits definitions for REG_PUB_APB_QOS_SWITCH, [0x310531C8] */
#define BIT_PUB_APB_URGENT_CHN_SEL                          ( BIT(1) )
#define BIT_PUB_APB_QOS_URGENT_SEL                          ( BIT(0) )

/* bits definitions for REG_PUB_APB_PUB_BUS_CK_EB, [0x310531CC] */
...
/* bits definitions for REG_PUB_APB_AXI_LPC_CTRL_3, [0x310531D0] */
...
/* bits definitions for REG_PUB_APB_PUB_INT_CG_EN, [0x310531D4] */
...
/* bits definitions for REG_PUB_APB_TIMER_ENABLE, [0x310531D8] */
...
/* bits definitions for REG_PUB_APB_VOTE_CTRL, [0x310531E0] */
...
/* bits definitions for REG_PUB_APB_VOTE_STATUS, [0x310531E4] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_CTRL3, [0x310531F0] */
...
/* bits definitions for REG_PUB_APB_QOS_FIXED_CTRL0, [0x310531F4] */
#define BIT_PUB_APB_DMC_FIXED_QOS_EN(x)                     ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)) )

/* bits definitions for REG_PUB_APB_QOS_FIXED_CTRL1, [0x310531F8] */
...
/* bits definitions for REG_PUB_APB_QOS_FIXED_CTRL2, [0x310531FC] */
...
/* bits definitions for REG_PUB_APB_PUB_AXI_QOS_URGENT_REG_0, [0x31053200] */
...
/* bits definitions for REG_PUB_APB_PUB_AXI_QOS_URGENT_REG_1, [0x31053204] */
...
/* bits definitions for REG_PUB_APB_PUB_INT_CTRL, [0x310532F0] */
...
/* bits definitions for REG_PUB_APB_DFS_STATUS, [0x310532F4] */
...
/* bits definitions for REG_PUB_APB_DFS_STATUS1, [0x310532F8] */
...
/* bits definitions for REG_PUB_APB_DFS_FC_REQ_DELAY, [0x310532FC] */
#define BIT_PUB_APB_DFS_FC_REQ_DELAY(x)                     ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)) )

/* bits definitions for REG_PUB_APB_PUB_LP_GEN_CTRL, [0x3105333C] */
...
/* bits definitions for REG_PUB_APB_AXI_LPC_CTRL_0, [0x3105334C] */
...
/* bits definitions for REG_PUB_APB_AXI_LPC_CTRL_1, [0x31053350] */
...
/* bits definitions for REG_PUB_APB_AXI_LPC_CTRL_2, [0x31053354] */
#define BIT_PUB_APB_LP_NUM_PUB_CFG(x)                       ( (x) << 16 & (0xFFFF0000) )
#define BIT_PUB_APB_LP_NUM(x)                               ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_PUB_APB_FENCING_CTRL, [0x31053358] */
...
/* bits definitions for REG_PUB_APB_CP_BASE_ADDR, [0x31053360] */
#define BIT_PUB_APB_AON_BASE_ADDR(x)                        ( (x) << 15 & (BIT(15)|BIT(16)|BIT(17)|BIT(18)|BIT(19)) )
#define BIT_PUB_APB_AG_CP_BASE_ADDR(x)                      ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)) )

/* bits definitions for REG_PUB_APB_CLK_PUB_DFS_CTRL, [0x31053364] */
#define BIT_PUB_APB_PUB_CP_BASE_ADDR(x)                     ( (x) << 16 & (BIT(16)|BIT(17)|BIT(18)|BIT(19)|BIT(20)|BIT(21)|BIT(22)|BIT(23)|BIT(24)|BIT(25)|BIT(26)|BIT(27)|BIT(28)) )
#define BIT_PUB_APB_WTL_CP_BASE_ADDR(x)                     ( (x) << 3  & (BIT(3)|BIT(4)|BIT(5)|BIT(6)|BIT(7)|BIT(8)|BIT(9)|BIT(10)|BIT(11)|BIT(12)|BIT(13)|BIT(14)|BIT(15)) )
...
/* bits definitions for REG_PUB_APB_BIST_CTRL, [0x31053400] */
...
/* bits definitions for REG_PUB_APB_DMC_SOFT_RST_CTRL, [0x31053404] */
#define BIT_PUB_APB_DMC_SOFT_RST                            ( BIT(2) )
#define BIT_PUB_APB_DCC_SOFT_RST                            ( BIT(1) )
#define BIT_PUB_APB_DDRPHY_SOFT_RST                         ( BIT(0) )

/* bits definitions for REG_PUB_APB_MC_IDLE_WAIT_CTRL, [0x31053414] */
#define BIT_PUB_APB_MC_IDLE_WAIT_CTRL(x)                    ( (x) )

/* bits definitions for REG_PUB_APB_QOS_THRESHOLD_0, [0x31053418] */
...
/* bits definitions for REG_PUB_APB_QOS_THRESHOLD_1, [0x3105341C] */
...
/* bits definitions for REG_PUB_APB_DMC_DDR_CLK_CTRL, [0x31054000] */
...
/* bits definitions for REG_PUB_APB_DMC_CLK_INIT_SW_START, [0x31054004] */
#define BIT_PUB_APB_DMC_CLK_INIT_SW_START                   ( BIT(0) )

/* bits definitions for REG_PUB_APB_DMC_CLK_STATE, [0x31054008] */
...
/* bits definitions for REG_PUB_APB_DMC_CLK_INIT_CFG, [0x3105400C] */
...
/* bits definitions for REG_PUB_APB_DMC_DESKEW_WAIT_CFG, [0x31054010] */
...
/* bits definitions for REG_PUB_APB_DMC_DESKEW_WAIT_CNT0, [0x31054014] */
...
/* bits definitions for REG_PUB_APB_DMC_DESKEW_WAIT_CNT1, [0x31054018] */
...
/* bits definitions for REG_PUB_APB_DMC_DESKEW_WAIT_CNT2, [0x3105401C] */
...
/* bits definitions for REG_PUB_APB_DMC_DESKEW_WAIT_CNT3, [0x31054020] */
...
/* bits definitions for REG_PUB_APB_DMC_DDL_CTRL, [0x3105402C] */
...
/* bits definitions for REG_PUB_APB_DFS_PURE_SW_CTRL, [0x31054100] */
...
/* bits definitions for REG_PUB_APB_DFS_SW_CTRL, [0x31054104] */
...
/* bits definitions for REG_PUB_APB_DFS_SW_CTRL1, [0x31054108] */
...
/* bits definitions for REG_PUB_APB_DFS_SW_CTRL2, [0x3105410C] */
...
/* bits definitions for REG_PUB_APB_DFS_SW_CTRL3, [0x31054110] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_CTRL, [0x31054114] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_CTRL1, [0x31054118] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_CTRL2, [0x3105411C] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_RATIO_SET0, [0x31054120] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_RATIO_SET1, [0x31054124] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_RATIO_SET2, [0x31054128] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_RATIO_SET3, [0x3105412C] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_RATIO_SET4, [0x31054130] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_RATIO_SET5, [0x31054134] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_RATIO_SET6, [0x31054138] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_RATIO_SET7, [0x3105413C] */
...
/* bits definitions for REG_PUB_APB_DFS_HW_RATIO_SET8, [0x31054140] */
...
/* bits definitions for REG_PUB_APB_HW_DESKEWPLL_PD_CTRL0, [0x31054144] */
...
/* bits definitions for REG_PUB_APB_HW_DESKEWPLL_PD_CTRL1, [0x31054148] */
...
/* bits definitions for REG_PUB_APB_DVS_CTRL_0, [0x31054150] */
...
/* bits definitions for REG_PUB_APB_DVS_CTRL_1, [0x31054154] */
...
/* bits definitions for REG_PUB_APB_DVS_CTRL_2, [0x31054158] */
...
/* bits definitions for REG_PUB_APB_DVS_DEC_BLOCK_TIME, [0x3105415C] */
#define BIT_PUB_APB_DVS_DEC_BLOCK_TIME(x)                   ( (x) )

/* bits definitions for REG_PUB_APB_VOTE_MASTER_EN, [0x31054310] */
...
/* bits definitions for REG_PUB_APB_VOTE_FSM_CNT, [0x31054314] */
...
/* bits definitions for REG_PUB_APB_THRESHOLD_INC_FREQ_0, [0x31054318] */
...
/* bits definitions for REG_PUB_APB_THRESHOLD_INC_FREQ_1, [0x3105431C] */
...
/* bits definitions for REG_PUB_APB_THRESHOLD_INC_FREQ_2, [0x31054320] */
...
/* bits definitions for REG_PUB_APB_THRESHOLD_INC_FREQ_3, [0x31054324] */
...
/* bits definitions for REG_PUB_APB_TEST_DSKPLL_BIST_CNT, [0x31054328] */
#define BIT_PUB_APB_TEST_DSKPLL_BIST_CNT(x)                 ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_PUB_APB_PUB_STATUS_MON_CTRL, [0x31056200] */
...
/* bits definitions for REG_PUB_APB_PUB_ST_IDLE_CYC_CNT, [0x31056204] */
#define BIT_PUB_APB_DMC_ST_IDLE_CYCLE_CNT(x)                ( (x) )

/* bits definitions for REG_PUB_APB_PUB_ST_WR_CYC_CNT, [0x31056208] */
#define BIT_PUB_APB_DMC_ST_WRITE_CYCLE_CNT(x)               ( (x) )

/* bits definitions for REG_PUB_APB_PUB_ST_RD_CYC_CNT, [0x3105620C] */
#define BIT_PUB_APB_DMC_ST_READ_CYCLE_CNT(x)                ( (x) )

/* bits definitions for REG_PUB_APB_PUB_ST_SR_CYC_CNT, [0x31056210] */
#define BIT_PUB_APB_DMC_ST_SREF_CYCLE_CNT(x)                ( (x) )

/* bits definitions for REG_PUB_APB_PUB_ST_LS_CYC_CNT, [0x31056214] */
#define BIT_PUB_APB_DMC_ST_LIGHT_CYCLE_CNT(x)               ( (x) )

/* bits definitions for REG_PUB_APB_PUB_ST_LS_TIME_CNT, [0x31056218] */
#define BIT_PUB_APB_DMC_ST_SREF_CNT(x)                      ( (x) << 16 & (0xFFFF0000) )
#define BIT_PUB_APB_DMC_ST_LIGHT_CNT(x)                     ( (x) << 0  & (0x0000FFFF) )

/* bits definitions for REG_PUB_APB_PUB_DFS_F0_CYC_CNT, [0x3105621C] */
#define BIT_PUB_APB_DFS_F0_CYCLE_CNT(x)                     ( (x) )

/* bits definitions for REG_PUB_APB_PUB_DFS_F1_CYC_CNT, [0x31056220] */
#define BIT_PUB_APB_DFS_F1_CYCLE_CNT(x)                     ( (x) )

/* bits definitions for REG_PUB_APB_PUB_DFS_F2_CYC_CNT, [0x31056224] */
#define BIT_PUB_APB_DFS_F2_CYCLE_CNT(x)                     ( (x) )

/* bits definitions for REG_PUB_APB_PUB_DFS_F3_CYC_CNT, [0x31056228] */
#define BIT_PUB_APB_DFS_F3_CYCLE_CNT(x)                     ( (x) )

/* bits definitions for REG_PUB_APB_PUB_DFS_F4_CYC_CNT, [0x3105622C] */
#define BIT_PUB_APB_DFS_F4_CYCLE_CNT(x)                     ( (x) )

/* bits definitions for REG_PUB_APB_PUB_DFS_F5_CYC_CNT, [0x31056230] */
#define BIT_PUB_APB_DFS_F5_CYCLE_CNT(x)                     ( (x) )

/* bits definitions for REG_PUB_APB_PUB_DFS_F6_CYC_CNT, [0x31056234] */
#define BIT_PUB_APB_DFS_F6_CYCLE_CNT(x)                     ( (x) )

/* bits definitions for REG_PUB_APB_PUB_DFS_F7_CYC_CNT, [0x31056238] */
#define BIT_PUB_APB_DFS_F7_CYCLE_CNT(x)                     ( (x) )

/* bits definitions for REG_PUB_APB_PUB_DFS_CNT, [0x3105623C] */
...
/* bits definitions for REG_PUB_APB_VOTE_CTRL_DPU, [0x31056400] */
...
/* bits definitions for REG_PUB_APB_VOTE_CTRL_DCAM, [0x31056404] */
...
/* bits definitions for REG_PUB_APB_VOTE_CTRL_PUBCP, [0x31056408] */
...
/* bits definitions for REG_PUB_APB_VOTE_CTRL_WTLCP, [0x3105640C] */
...
/* bits definitions for REG_PUB_APB_VOTE_CTRL_WTLCP1, [0x31056410] */
...
/* bits definitions for REG_PUB_APB_VOTE_CTRL_AGCP, [0x31056414] */
...
/* bits definitions for REG_PUB_APB_VOTE_CTRL_SW, [0x31056418] */
...
/* bits definitions for REG_PUB_APB_VOTE_CTRL_VDSP, [0x3105641C] */
...
/* bits definitions for REG_PUB_APB_DFS_GFREE_CTRL, [0x31056500] */
...
/* bits definitions for REG_PUB_APB_DFS_SW_CTRL_APPEND, [0x31056600] */
#define BIT_PUB_APB_PUB_DFS_SW_SWITCH_PERIOD_APPEND(x)      ( (x) << 0  & (BIT(0)|BIT(1)|BIT(2)|BIT(3)) )

/* bits definitions for REG_PUB_APB_AWURGENT_DBG_CTRL, [0x31056800] */
...
/* bits definitions for REG_PUB_APB_ARURGENT_DBG_CTRL, [0x31056804] */
...
/* bits definitions for REG_PUB_APB_LSLP_SRE_SIM, [0x31056808] */
#define BIT_PUB_APB_SRE_FLAG_DBG                            ( BIT(1) )
#define BIT_PUB_APB_SRE_REQ_DBG                             ( BIT(0) )

/* bits definitions for REG_PUB_APB_PUB0_DUMMY_REG0, [0x31058000] */
...
/* bits definitions for REG_PUB_APB_PUB0_DUMMY_REG1, [0x31058004] */
