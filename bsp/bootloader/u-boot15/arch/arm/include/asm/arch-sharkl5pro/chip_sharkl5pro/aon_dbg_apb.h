...
#define CTL_AON_DBG_APB_BASE            SCI_IOMAP(0x32890000)
#endif

/* registers definitions for CTL_AON_DBG_APB, 0x32890000 */
...
/* bits definitions for REG_AON_DBG_APB_APCPU_COMM_CTRL, [0x32890000] */
...
/* bits definitions for REG_AON_DBG_APB_APCPU_PROT_CTRL, [0x32890004] */
...
/* bits definitions for REG_AON_DBG_APB_CSSYS_CFG, [0x32890008] */
...
/* bits definitions for REG_AON_DBG_APB_CR5_PROT_CTRL, [0x3289000C] */
#define BIT_AON_DBG_APB_CR5_NIDEN                           ( BIT(1) )
#define BIT_AON_DBG_APB_CR5_DBGEN                           ( BIT(0) )

/* bits definitions for REG_AON_DBG_APB_APCPU_PROT_CTRL_NON_SEC, [0x32890010] */
...
/* bits definitions for REG_AON_DBG_APB_CSSYS_CFG_NON_SEC, [0x32890014] */
...
/* bits definitions for REG_AON_DBG_APB_CR5_PROT_CTRL_NON_SEC, [0x32890018] */
#define BIT_AON_DBG_APB_CR5_NIDEN_NON_SEC                   ( BIT(1) )
#define BIT_AON_DBG_APB_CR5_DBGEN_NON_SEC                   ( BIT(0) )

/* bits definitions for REG_AON_DBG_APB_DEBUG_BOND_OPTION, [0x3289001C] */
