...
static jint VMDebug_getGlobalsRefNum(JNIEnv* env, jclass) {
  ScopedObjectAccess soa(env);
  return soa.Vm()->GetGlobalsRefNum();
}

static jint VMDebug_getWeakRefNum(JNIEnv* env, jclass) {
  ScopedObjectAccess soa(env);
  return soa.Vm()->GetWeakRefNum();
}
...
static JNINativeMethod gMethods[] = {
  ...
  NATIVE_METHOD(VMDebug, getGlobalsRefNum, "()I"),
  NATIVE_METHOD(VMDebug, getWeakRefNum, "()I"),
